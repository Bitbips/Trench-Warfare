...
try { let fnprepatch_573 = CarSimMovementComponent.prototype.ResetVsVehicle;CarSimMovementComponent.prototype.ResetVsVehicle = function (applyResetPosAndOri = true) { return fnprepatch_573.call(this, applyResetPosAndOri) }; } catch (e) {};
try { let fnprepatch_574 = VsConnect.prototype.Listen_IP;VsConnect.prototype.Listen_IP = function (ListenAddress, port = 0, maxConnections = 1, allowBlockingForTimeSerialization = false) { return fnprepatch_574.call(this, ListenAddress, port, maxConnections, allowBlockingForTimeSerialization) }; } catch (e) {};
try { let fnprepatch_575 = CreaturePackMeshComponent.prototype.GetAttachmentPosition;CreaturePackMeshComponent.prototype.GetAttachmentPosition = function (vertex_id = -1) { return fnprepatch_575.call(this, vertex_id) }; } catch (e) {};
try { let fnprepatch_576 = DonNavigationManager.prototype.ScheduleDynamicCollisionUpdate;DonNavigationManager.prototype.ScheduleDynamicCollisionUpdate = function (Mesh, ResultHandler, CustomCacheIdentifier = "None", bReplaceExistingTask = false, bDisableCacheUsage = false, bReloadCollisionCache = false, bUseCheapBoundsCollision = false, BoundsScaleFactor = 1, bForceSynchronousExecution = false, bDrawDebug = false) { return fnprepatch_576.call(this, Mesh, ResultHandler, CustomCacheIdentifier, bReplaceExistingTask, bDisableCacheUsage, bReloadCollisionCache, bUseCheapBoundsCollision, BoundsScaleFactor, bForceSynchronousExecution, bDrawDebug) }; } catch (e) {};
try { let fnprepatch_577 = DonNavigationManager.prototype.IsMeshBoundsWithinNavigableWorld;DonNavigationManager.prototype.IsMeshBoundsWithinNavigableWorld = function (Mesh, BoundsScaleFactor = 1) { return fnprepatch_577.call(this, Mesh, BoundsScaleFactor) }; } catch (e) {};
try { let fnprepatch_578 = DonNavigationManager.prototype.IsLocationBeneathLandscape;DonNavigationManager.prototype.IsLocationBeneathLandscape = function (Location, LineTraceHeight = 3000) { return fnprepatch_578.call(this, Location, LineTraceHeight) }; } catch (e) {};
try { let fnprepatch_579 = DonNavigationManager.prototype.IsDirectPathSweep;DonNavigationManager.prototype.IsDirectPathSweep = function (CollisionComponent, Start, End, OutHit, bFindInitialOverlaps = false, CollisionShapeInflation = 0) { return fnprepatch_579.call(this, CollisionComponent, Start, End, OutHit, bFindInitialOverlaps, CollisionShapeInflation) }; } catch (e) {};
try { let fnprepatch_580 = DonNavigationManager.prototype.IsDirectPathLineTrace;DonNavigationManager.prototype.IsDirectPathLineTrace = function (start, end, OutHit, ActorsToIgnore, bFindInitialOverlaps = true) { return fnprepatch_580.call(this, start, end, OutHit, ActorsToIgnore, bFindInitialOverlaps) }; } catch (e) {};
try { let fnprepatch_581 = DonNavigationManager.prototype.IsDirectPathLineSweep;DonNavigationManager.prototype.IsDirectPathLineSweep = function (CollisionComponent, Start, End, OutHit, bFindInitialOverlaps = false, CollisionShapeInflation = 0) { return fnprepatch_581.call(this, CollisionComponent, Start, End, OutHit, bFindInitialOverlaps, CollisionShapeInflation) }; } catch (e) {};
try { let fnprepatch_582 = DonNavigationManager.prototype.FindRandomPointFromActorInNavWorld;DonNavigationManager.prototype.FindRandomPointFromActorInNavWorld = function (Actor, Distance, bFoundValidResult, MaxDesiredAltitude = -1, MaxZAngularDispacement = 15, MaxAttempts = 5) { return fnprepatch_582.call(this, Actor, Distance, bFoundValidResult, MaxDesiredAltitude, MaxZAngularDispacement, MaxAttempts) }; } catch (e) {};
try { let fnprepatch_583 = DonNavigationManager.prototype.FindRandomPointAroundOriginInNavWorld;DonNavigationManager.prototype.FindRandomPointAroundOriginInNavWorld = function (NavigationActor, Origin, Distance, bFoundValidResult, MaxDesiredAltitude = -1, MaxZAngularDispacement = 15, MaxAttempts = 5) { return fnprepatch_583.call(this, NavigationActor, Origin, Distance, bFoundValidResult, MaxDesiredAltitude, MaxZAngularDispacement, MaxAttempts) }; } catch (e) {};
try { let fnprepatch_584 = DonNavigationManager.prototype.Debug_DrawVoxelCollisionProfile;DonNavigationManager.prototype.Debug_DrawVoxelCollisionProfile = function (MeshOrPrimitive, bDrawPersistent = false, Duration = 2) { return fnprepatch_584.call(this, MeshOrPrimitive, bDrawPersistent, Duration) }; } catch (e) {};
try { let fnprepatch_585 = DonNavigationManager.prototype.Debug_DrawVolumesAroundPoint;DonNavigationManager.prototype.Debug_DrawVolumesAroundPoint = function (Location, CubeSize, DrawPersistentLines, Duration, LineThickness, bAutoInitializeVolumes = false) { return fnprepatch_585.call(this, Location, CubeSize, DrawPersistentLines, Duration, LineThickness, bAutoInitializeVolumes) }; } catch (e) {};
try { FactionAgentInterface.prototype.SetFaction = FactionAgentInterface.prototype.EventSetFaction; } catch (e) {};
try { FactionAgentInterface.prototype.GetFaction = FactionAgentInterface.prototype.EventGetFaction; } catch (e) {};
try { FactionsLibrary.prototype.IsNone = FactionsLibrary.prototype.FactionIsNone; } catch (e) {};
try { FactionsLibrary.IsNone = FactionsLibrary.FactionIsNone; } catch (e) {};
...
try { let fnprepatch_586 = LowEntryDouble.prototype.SetBytes;LowEntryDouble.prototype.SetBytes = function (ByteArray, Index = 0, Length = 2147483647) { return fnprepatch_586.call(this, ByteArray, Index, Length) }; } catch (e) {};
try { let fnprepatch_587 = LowEntryDouble.prototype.CastToString;LowEntryDouble.prototype.CastToString = function (MinFractionalDigits = 1) { return fnprepatch_587.call(this, MinFractionalDigits) }; } catch (e) {};
...
try { let fnprepatch_588 = LowEntryExtendedStandardLibrary.prototype.TextureRenderTarget2DToBytes;LowEntryExtendedStandardLibrary.prototype.TextureRenderTarget2DToBytes = function (TextureRenderTarget2D, ImageFormat, ByteArray, CompressionQuality = 0) { return fnprepatch_588.call(this, TextureRenderTarget2D, ImageFormat, ByteArray, CompressionQuality) }; } catch (e) {};
try { let fnprepatch_589 = LowEntryExtendedStandardLibrary.prototype.Texture2DToBytes;LowEntryExtendedStandardLibrary.prototype.Texture2DToBytes = function (Texture2D, ImageFormat, ByteArray, CompressionQuality = 0) { return fnprepatch_589.call(this, Texture2D, ImageFormat, ByteArray, CompressionQuality) }; } catch (e) {};
try { let fnprepatch_590 = LowEntryExtendedStandardLibrary.prototype.SortTimespanArrayDirectly;LowEntryExtendedStandardLibrary.prototype.SortTimespanArrayDirectly = function (TimespanArray, Reversed = false) { return fnprepatch_590.call(this, TimespanArray, Reversed) }; } catch (e) {};
try { let fnprepatch_591 = LowEntryExtendedStandardLibrary.prototype.SortTimespanArray;LowEntryExtendedStandardLibrary.prototype.SortTimespanArray = function (TimespanArray, Reversed = false) { return fnprepatch_591.call(this, TimespanArray, Reversed) }; } catch (e) {};
try { let fnprepatch_592 = LowEntryExtendedStandardLibrary.prototype.SortStringArrayDirectly;LowEntryExtendedStandardLibrary.prototype.SortStringArrayDirectly = function (StringArray, Reversed = false) { return fnprepatch_592.call(this, StringArray, Reversed) }; } catch (e) {};
try { let fnprepatch_593 = LowEntryExtendedStandardLibrary.prototype.SortStringArray;LowEntryExtendedStandardLibrary.prototype.SortStringArray = function (StringArray, Reversed = false) { return fnprepatch_593.call(this, StringArray, Reversed) }; } catch (e) {};
try { let fnprepatch_594 = LowEntryExtendedStandardLibrary.prototype.SortObjectArray;LowEntryExtendedStandardLibrary.prototype.SortObjectArray = function (ObjectArray, Comparator, Reversed = false) { return fnprepatch_594.call(this, ObjectArray, Comparator, Reversed) }; } catch (e) {};
try { let fnprepatch_595 = LowEntryExtendedStandardLibrary.prototype.SortIntegerArrayDirectly;LowEntryExtendedStandardLibrary.prototype.SortIntegerArrayDirectly = function (IntegerArray, Reversed = false) { return fnprepatch_595.call(this, IntegerArray, Reversed) }; } catch (e) {};
try { let fnprepatch_596 = LowEntryExtendedStandardLibrary.prototype.SortIntegerArray;LowEntryExtendedStandardLibrary.prototype.SortIntegerArray = function (IntegerArray, Reversed = false) { return fnprepatch_596.call(this, IntegerArray, Reversed) }; } catch (e) {};
try { let fnprepatch_597 = LowEntryExtendedStandardLibrary.prototype.SortFloatArrayDirectly;LowEntryExtendedStandardLibrary.prototype.SortFloatArrayDirectly = function (FloatArray, Reversed = false) { return fnprepatch_597.call(this, FloatArray, Reversed) }; } catch (e) {};
try { let fnprepatch_598 = LowEntryExtendedStandardLibrary.prototype.SortFloatArray;LowEntryExtendedStandardLibrary.prototype.SortFloatArray = function (FloatArray, Reversed = false) { return fnprepatch_598.call(this, FloatArray, Reversed) }; } catch (e) {};
try { let fnprepatch_599 = LowEntryExtendedStandardLibrary.prototype.SortDateTimeArrayDirectly;LowEntryExtendedStandardLibrary.prototype.SortDateTimeArrayDirectly = function (DateTimeArray, Reversed = false) { return fnprepatch_599.call(this, DateTimeArray, Reversed) }; } catch (e) {};
try { let fnprepatch_600 = LowEntryExtendedStandardLibrary.prototype.SortDateTimeArray;LowEntryExtendedStandardLibrary.prototype.SortDateTimeArray = function (DateTimeArray, Reversed = false) { return fnprepatch_600.call(this, DateTimeArray, Reversed) }; } catch (e) {};
try { let fnprepatch_601 = LowEntryExtendedStandardLibrary.prototype.SortByteArrayDirectly;LowEntryExtendedStandardLibrary.prototype.SortByteArrayDirectly = function (ByteArray, Reversed = false) { return fnprepatch_601.call(this, ByteArray, Reversed) }; } catch (e) {};
try { let fnprepatch_602 = LowEntryExtendedStandardLibrary.prototype.SortByteArray;LowEntryExtendedStandardLibrary.prototype.SortByteArray = function (ByteArray, Reversed = false) { return fnprepatch_602.call(this, ByteArray, Reversed) }; } catch (e) {};
try { let fnprepatch_603 = LowEntryExtendedStandardLibrary.prototype.Sha512;LowEntryExtendedStandardLibrary.prototype.Sha512 = function (ByteArray, Index = 0, Length = 2147483647) { return fnprepatch_603.call(this, ByteArray, Index, Length) }; } catch (e) {};
try { let fnprepatch_604 = LowEntryExtendedStandardLibrary.prototype.Sha256;LowEntryExtendedStandardLibrary.prototype.Sha256 = function (ByteArray, Index = 0, Length = 2147483647) { return fnprepatch_604.call(this, ByteArray, Index, Length) }; } catch (e) {};
try { let fnprepatch_605 = LowEntryExtendedStandardLibrary.prototype.Sha1;LowEntryExtendedStandardLibrary.prototype.Sha1 = function (ByteArray, Index = 0, Length = 2147483647) { return fnprepatch_605.call(this, ByteArray, Index, Length) }; } catch (e) {};
try { let fnprepatch_606 = LowEntryExtendedStandardLibrary.prototype.ServerChangeMap;LowEntryExtendedStandardLibrary.prototype.ServerChangeMap = function (WorldContextObject, Map, Args, SpecificPlayer = undefined) { return fnprepatch_606.call(this, WorldContextObject, Map, Args, SpecificPlayer) }; } catch (e) {};
try { let fnprepatch_607 = LowEntryExtendedStandardLibrary.prototype.SceneCaptureComponent2DToBytes;LowEntryExtendedStandardLibrary.prototype.SceneCaptureComponent2DToBytes = function (SceneCaptureComponent2D, ImageFormat, ByteArray, CompressionQuality = 0) { return fnprepatch_607.call(this, SceneCaptureComponent2D, ImageFormat, ByteArray, CompressionQuality) }; } catch (e) {};
try { let fnprepatch_608 = LowEntryExtendedStandardLibrary.prototype.SceneCapture2DToBytes;LowEntryExtendedStandardLibrary.prototype.SceneCapture2DToBytes = function (SceneCapture2D, ImageFormat, ByteArray, CompressionQuality = 0) { return fnprepatch_608.call(this, SceneCapture2D, ImageFormat, ByteArray, CompressionQuality) }; } catch (e) {};
try { let fnprepatch_609 = LowEntryExtendedStandardLibrary.prototype.PixelsToBytes;LowEntryExtendedStandardLibrary.prototype.PixelsToBytes = function (Width, Height, Pixels, ImageFormat, ByteArray, CompressionQuality = 0) { return fnprepatch_609.call(this, Width, Height, Pixels, ImageFormat, ByteArray, CompressionQuality) }; } catch (e) {};
try { let fnprepatch_610 = LowEntryExtendedStandardLibrary.prototype.Pearson;LowEntryExtendedStandardLibrary.prototype.Pearson = function (ByteArray, HashLength, Index = 0, Length = 2147483647) { return fnprepatch_610.call(this, ByteArray, HashLength, Index, Length) }; } catch (e) {};
try { let fnprepatch_611 = LowEntryExtendedStandardLibrary.prototype.Md5;LowEntryExtendedStandardLibrary.prototype.Md5 = function (ByteArray, Index = 0, Length = 2147483647) { return fnprepatch_611.call(this, ByteArray, Index, Length) }; } catch (e) {};
try { let fnprepatch_612 = LowEntryExtendedStandardLibrary.prototype.Long_Create;LowEntryExtendedStandardLibrary.prototype.Long_Create = function (ByteArray, Index = 0, Length = 2147483647) { return fnprepatch_612.call(this, ByteArray, Index, Length) }; } catch (e) {};
try { let fnprepatch_613 = LowEntryExtendedStandardLibrary.prototype.LoadVideo;LowEntryExtendedStandardLibrary.prototype.LoadVideo = function (MediaSoundComponent, Url, Success, MediaPlayer, MediaTexture, PlayOnOpen = true, Loop = true) { return fnprepatch_613.call(this, MediaSoundComponent, Url, Success, MediaPlayer, MediaTexture, PlayOnOpen, Loop) }; } catch (e) {};
try { let fnprepatch_614 = LowEntryExtendedStandardLibrary.prototype.JoinGame;LowEntryExtendedStandardLibrary.prototype.JoinGame = function (WorldContextObject, ServerAddress, Args, SpecificPlayer = undefined) { return fnprepatch_614.call(this, WorldContextObject, ServerAddress, Args, SpecificPlayer) }; } catch (e) {};
try { let fnprepatch_615 = LowEntryExtendedStandardLibrary.prototype.HostGame;LowEntryExtendedStandardLibrary.prototype.HostGame = function (WorldContextObject, Map, Args, SpecificPlayer = undefined) { return fnprepatch_615.call(this, WorldContextObject, Map, Args, SpecificPlayer) }; } catch (e) {};
try { let fnprepatch_616 = LowEntryExtendedStandardLibrary.prototype.HMAC;LowEntryExtendedStandardLibrary.prototype.HMAC = function (ByteArray, Key, Algorithm = "MD5", Index = 0, Length = 2147483647) { return fnprepatch_616.call(this, ByteArray, Key, Algorithm, Index, Length) }; } catch (e) {};
try { let fnprepatch_617 = LowEntryExtendedStandardLibrary.prototype.HashcashCustomCreationDate;LowEntryExtendedStandardLibrary.prototype.HashcashCustomCreationDate = function (Resource, UtcDate, Bits = 22) { return fnprepatch_617.call(this, Resource, UtcDate, Bits) }; } catch (e) {};
try { let fnprepatch_618 = LowEntryExtendedStandardLibrary.prototype.HashcashArrayCustomCreationDate;LowEntryExtendedStandardLibrary.prototype.HashcashArrayCustomCreationDate = function (Resources, UtcDate, Bits = 22) { return fnprepatch_618.call(this, Resources, UtcDate, Bits) }; } catch (e) {};
try { let fnprepatch_619 = LowEntryExtendedStandardLibrary.prototype.HashcashArray;LowEntryExtendedStandardLibrary.prototype.HashcashArray = function (Resources, Bits = 22) { return fnprepatch_619.call(this, Resources, Bits) }; } catch (e) {};
try { let fnprepatch_620 = LowEntryExtendedStandardLibrary.prototype.Hashcash;LowEntryExtendedStandardLibrary.prototype.Hashcash = function (Resource, Bits = 22) { return fnprepatch_620.call(this, Resource, Bits) }; } catch (e) {};
try { let fnprepatch_621 = LowEntryExtendedStandardLibrary.prototype.Double_Create;LowEntryExtendedStandardLibrary.prototype.Double_Create = function (ByteArray, Index = 0, Length = 2147483647) { return fnprepatch_621.call(this, ByteArray, Index, Length) }; } catch (e) {};
try { let fnprepatch_622 = LowEntryExtendedStandardLibrary.prototype.DateTime_ToString;LowEntryExtendedStandardLibrary.prototype.DateTime_ToString = function (DateTime, String, Format = "%Y.%m.%d-%H.%M.%S") { return fnprepatch_622.call(this, DateTime, String, Format) }; } catch (e) {};
try { let fnprepatch_623 = LowEntryExtendedStandardLibrary.prototype.CreateString;LowEntryExtendedStandardLibrary.prototype.CreateString = function (Length, Filler = " ") { return fnprepatch_623.call(this, Length, Filler) }; } catch (e) {};
try { let fnprepatch_624 = LowEntryExtendedStandardLibrary.prototype.ChangeMap;LowEntryExtendedStandardLibrary.prototype.ChangeMap = function (WorldContextObject, Map, Args, SpecificPlayer = undefined) { return fnprepatch_624.call(this, WorldContextObject, Map, Args, SpecificPlayer) }; } catch (e) {};
try { let fnprepatch_625 = LowEntryExtendedStandardLibrary.prototype.BytesToStringUtf8;LowEntryExtendedStandardLibrary.prototype.BytesToStringUtf8 = function (ByteArray, Index = 0, Length = 2147483647) { return fnprepatch_625.call(this, ByteArray, Index, Length) }; } catch (e) {};
try { let fnprepatch_626 = LowEntryExtendedStandardLibrary.prototype.BytesToPixels;LowEntryExtendedStandardLibrary.prototype.BytesToPixels = function (ByteArray, ImageFormat, Width, Height, Pixels, Index = 0, Length = 2147483647) { return fnprepatch_626.call(this, ByteArray, ImageFormat, Width, Height, Pixels, Index, Length) }; } catch (e) {};
try { let fnprepatch_627 = LowEntryExtendedStandardLibrary.prototype.BytesToLongBytes;LowEntryExtendedStandardLibrary.prototype.BytesToLongBytes = function (ByteArray, Index = 0, Length = 2147483647) { return fnprepatch_627.call(this, ByteArray, Index, Length) }; } catch (e) {};
try { let fnprepatch_628 = LowEntryExtendedStandardLibrary.prototype.BytesToInteger;LowEntryExtendedStandardLibrary.prototype.BytesToInteger = function (ByteArray, Index = 0, Length = 2147483647) { return fnprepatch_628.call(this, ByteArray, Index, Length) }; } catch (e) {};
try { let fnprepatch_629 = LowEntryExtendedStandardLibrary.prototype.BytesToImage;LowEntryExtendedStandardLibrary.prototype.BytesToImage = function (ByteArray, ImageFormat, Index = 0, Length = 2147483647) { return fnprepatch_629.call(this, ByteArray, ImageFormat, Index, Length) }; } catch (e) {};
try { let fnprepatch_630 = LowEntryExtendedStandardLibrary.prototype.BytesToHex;LowEntryExtendedStandardLibrary.prototype.BytesToHex = function (ByteArray, AddSpaces = false, Index = 0, Length = 2147483647) { return fnprepatch_630.call(this, ByteArray, AddSpaces, Index, Length) }; } catch (e) {};
try { let fnprepatch_631 = LowEntryExtendedStandardLibrary.prototype.BytesToFloat;LowEntryExtendedStandardLibrary.prototype.BytesToFloat = function (ByteArray, Index = 0, Length = 2147483647) { return fnprepatch_631.call(this, ByteArray, Index, Length) }; } catch (e) {};
try { let fnprepatch_632 = LowEntryExtendedStandardLibrary.prototype.BytesToExistingImage;LowEntryExtendedStandardLibrary.prototype.BytesToExistingImage = function (ReusedGivenTexture2D, Texture2D, ByteArray, ImageFormat, Index = 0, Length = 2147483647) { return fnprepatch_632.call(this, ReusedGivenTexture2D, Texture2D, ByteArray, ImageFormat, Index, Length) }; } catch (e) {};
try { let fnprepatch_633 = LowEntryExtendedStandardLibrary.prototype.BytesToDoubleBytes;LowEntryExtendedStandardLibrary.prototype.BytesToDoubleBytes = function (ByteArray, Index = 0, Length = 2147483647) { return fnprepatch_633.call(this, ByteArray, Index, Length) }; } catch (e) {};
try { let fnprepatch_634 = LowEntryExtendedStandardLibrary.prototype.BytesToByte;LowEntryExtendedStandardLibrary.prototype.BytesToByte = function (ByteArray, Index = 0, Length = 2147483647) { return fnprepatch_634.call(this, ByteArray, Index, Length) }; } catch (e) {};
try { let fnprepatch_635 = LowEntryExtendedStandardLibrary.prototype.BytesToBoolean;LowEntryExtendedStandardLibrary.prototype.BytesToBoolean = function (ByteArray, Index = 0, Length = 2147483647) { return fnprepatch_635.call(this, ByteArray, Index, Length) }; } catch (e) {};
try { let fnprepatch_636 = LowEntryExtendedStandardLibrary.prototype.BytesToBitString;LowEntryExtendedStandardLibrary.prototype.BytesToBitString = function (ByteArray, AddSpaces = false, Index = 0, Length = 2147483647) { return fnprepatch_636.call(this, ByteArray, AddSpaces, Index, Length) }; } catch (e) {};
try { let fnprepatch_637 = LowEntryExtendedStandardLibrary.prototype.BytesToBinary;LowEntryExtendedStandardLibrary.prototype.BytesToBinary = function (ByteArray, AddSpaces = false, Index = 0, Length = 2147483647) { return fnprepatch_637.call(this, ByteArray, AddSpaces, Index, Length) }; } catch (e) {};
try { let fnprepatch_638 = LowEntryExtendedStandardLibrary.prototype.BytesToBase64Url;LowEntryExtendedStandardLibrary.prototype.BytesToBase64Url = function (ByteArray, Index = 0, Length = 2147483647) { return fnprepatch_638.call(this, ByteArray, Index, Length) }; } catch (e) {};
try { let fnprepatch_639 = LowEntryExtendedStandardLibrary.prototype.BytesToBase64;LowEntryExtendedStandardLibrary.prototype.BytesToBase64 = function (ByteArray, Index = 0, Length = 2147483647) { return fnprepatch_639.call(this, ByteArray, Index, Length) }; } catch (e) {};
try { let fnprepatch_640 = LowEntryExtendedStandardLibrary.prototype.BytesSubArray;LowEntryExtendedStandardLibrary.prototype.BytesSubArray = function (ByteArray, Index, Length = 2147483647) { return fnprepatch_640.call(this, ByteArray, Index, Length) }; } catch (e) {};
try { let fnprepatch_641 = LowEntryExtendedStandardLibrary.prototype.ByteDataReader_Create;LowEntryExtendedStandardLibrary.prototype.ByteDataReader_Create = function (Bytes, Index = 0, Length = 2147483647) { return fnprepatch_641.call(this, Bytes, Index, Length) }; } catch (e) {};
try { let fnprepatch_642 = LowEntryExtendedStandardLibrary.prototype.BitDataReader_Create;LowEntryExtendedStandardLibrary.prototype.BitDataReader_Create = function (Bytes, Index = 0, Length = 2147483647) { return fnprepatch_642.call(this, Bytes, Index, Length) }; } catch (e) {};
try { let fnprepatch_643 = LowEntryExtendedStandardLibrary.prototype.BCrypt;LowEntryExtendedStandardLibrary.prototype.BCrypt = function (ByteArray, Salt, Strength = 10, Index = 0, Length = 2147483647) { return fnprepatch_643.call(this, ByteArray, Salt, Strength, Index, Length) }; } catch (e) {};
try { let fnprepatch_644 = LowEntryExtendedStandardLibrary.prototype.AreBytesEqual;LowEntryExtendedStandardLibrary.prototype.AreBytesEqual = function (A, B, IndexA = 0, LengthA = 2147483647, IndexB = 0, LengthB = 2147483647) { return fnprepatch_644.call(this, A, B, IndexA, LengthA, IndexB, LengthB) }; } catch (e) {};
...
try { let fnprepatch_645 = LowEntryLong.prototype.SetBytes;LowEntryLong.prototype.SetBytes = function (ByteArray, Index = 0, Length = 2147483647) { return fnprepatch_645.call(this, ByteArray, Index, Length) }; } catch (e) {};
...
try { PlayFabJsonValue.prototype.ConstructJsonStringValue = PlayFabJsonValue.prototype.ConstructJsonValueString; } catch (e) {};
try { PlayFabJsonValue.ConstructJsonStringValue = PlayFabJsonValue.ConstructJsonValueString; } catch (e) {};
try { PlayFabJsonValue.prototype.ConstructJsonObjectValue = PlayFabJsonValue.prototype.ConstructJsonValueObject; } catch (e) {};
try { PlayFabJsonValue.ConstructJsonObjectValue = PlayFabJsonValue.ConstructJsonValueObject; } catch (e) {};
try { PlayFabJsonValue.prototype.ConstructJsonNumberValue = PlayFabJsonValue.prototype.ConstructJsonValueNumber; } catch (e) {};
try { PlayFabJsonValue.ConstructJsonNumberValue = PlayFabJsonValue.ConstructJsonValueNumber; } catch (e) {};
try { PlayFabJsonValue.prototype.ConstructJsonBoolValue = PlayFabJsonValue.prototype.ConstructJsonValueBool; } catch (e) {};
try { PlayFabJsonValue.ConstructJsonBoolValue = PlayFabJsonValue.ConstructJsonValueBool; } catch (e) {};
try { PlayFabJsonValue.prototype.ConstructJsonArrayValue = PlayFabJsonValue.prototype.ConstructJsonValueArray; } catch (e) {};
try { PlayFabJsonValue.ConstructJsonArrayValue = PlayFabJsonValue.ConstructJsonValueArray; } catch (e) {};
try { let fnprepatch_646 = PlayFabUtilities.prototype.getPhotonAppId;PlayFabUtilities.prototype.getPhotonAppId = function (Realtime = false, Chat = false, Turnbased = false) { return fnprepatch_646.call(this, Realtime, Chat, Turnbased) }; } catch (e) {};
try { let fnprepatch_647 = SaveManager.prototype.SaveSlotToId;SaveManager.prototype.SaveSlotToId = function (Slot = 0, bOverrideIfNeeded = true, bScreenshot = false, Width = 640, Height = 360) { return fnprepatch_647.call(this, Slot, bOverrideIfNeeded, bScreenshot, Width, Height) }; } catch (e) {};
try { let fnprepatch_648 = SaveManager.prototype.SaveSlot;SaveManager.prototype.SaveSlot = function (SlotInfo, bOverrideIfNeeded = true, bScreenshot = false, Width = 640, Height = 360) { return fnprepatch_648.call(this, SlotInfo, bOverrideIfNeeded, bScreenshot, Width, Height) }; } catch (e) {};
try { let fnprepatch_649 = SaveManager.prototype.SaveCurrentSlot;SaveManager.prototype.SaveCurrentSlot = function (bScreenshot = false, Width = 640, Height = 360) { return fnprepatch_649.call(this, bScreenshot, Width, Height) }; } catch (e) {};
try { let fnprepatch_650 = SaveManager.prototype.LoadSlotFromId;SaveManager.prototype.LoadSlotFromId = function (SlotId = 0) { return fnprepatch_650.call(this, SlotId) }; } catch (e) {};
try { let fnprepatch_651 = SaveManager.prototype.GetAllSlotInfos;SaveManager.prototype.GetAllSlotInfos = function (SaveInfos, bSortByRecent = false) { return fnprepatch_651.call(this, SaveInfos, bSortByRecent) }; } catch (e) {};
try { SaveManager.prototype.GenerateSaveSlot = SaveManager.prototype.EventGenerateSaveSlot; } catch (e) {};
try { SCLibrary.prototype.SetSafeVector4D = SCLibrary.prototype.SCL_Pure_SetSafeVector4DWithKey; } catch (e) {};
try { SCLibrary.SetSafeVector4D = SCLibrary.SCL_Pure_SetSafeVector4DWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeVector4D = SCLibrary.prototype.SCL_Pure_SetSafeVector4D; } catch (e) {};
try { SCLibrary.SetSafeVector4D = SCLibrary.SCL_Pure_SetSafeVector4D; } catch (e) {};
try { SCLibrary.prototype.SetSafeVector3D = SCLibrary.prototype.SCL_Pure_SetSafeVector3DWithKey; } catch (e) {};
try { SCLibrary.SetSafeVector3D = SCLibrary.SCL_Pure_SetSafeVector3DWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeVector3D = SCLibrary.prototype.SCL_Pure_SetSafeVector3D; } catch (e) {};
try { SCLibrary.SetSafeVector3D = SCLibrary.SCL_Pure_SetSafeVector3D; } catch (e) {};
try { SCLibrary.prototype.SetSafeVector2D = SCLibrary.prototype.SCL_Pure_SetSafeVector2DWithKey; } catch (e) {};
try { SCLibrary.SetSafeVector2D = SCLibrary.SCL_Pure_SetSafeVector2DWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeVector2D = SCLibrary.prototype.SCL_Pure_SetSafeVector2D; } catch (e) {};
try { SCLibrary.SetSafeVector2D = SCLibrary.SCL_Pure_SetSafeVector2D; } catch (e) {};
try { SCLibrary.prototype.SetSafeTransform = SCLibrary.prototype.SCL_Pure_SetSafeTransformWithKey; } catch (e) {};
try { SCLibrary.SetSafeTransform = SCLibrary.SCL_Pure_SetSafeTransformWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeTransform = SCLibrary.prototype.SCL_Pure_SetSafeTransform; } catch (e) {};
try { SCLibrary.SetSafeTransform = SCLibrary.SCL_Pure_SetSafeTransform; } catch (e) {};
try { SCLibrary.prototype.SetSafeText = SCLibrary.prototype.SCL_Pure_SetSafeTextWithKey; } catch (e) {};
try { SCLibrary.SetSafeText = SCLibrary.SCL_Pure_SetSafeTextWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeText = SCLibrary.prototype.SCL_Pure_SetSafeText; } catch (e) {};
try { SCLibrary.SetSafeText = SCLibrary.SCL_Pure_SetSafeText; } catch (e) {};
try { SCLibrary.prototype.SetSafeString = SCLibrary.prototype.SCL_Pure_SetSafeStringWithKey; } catch (e) {};
try { SCLibrary.SetSafeString = SCLibrary.SCL_Pure_SetSafeStringWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeString = SCLibrary.prototype.SCL_Pure_SetSafeString; } catch (e) {};
try { SCLibrary.SetSafeString = SCLibrary.SCL_Pure_SetSafeString; } catch (e) {};
try { SCLibrary.prototype.SetSafeRotator = SCLibrary.prototype.SCL_Pure_SetSafeRotatorWithKey; } catch (e) {};
try { SCLibrary.SetSafeRotator = SCLibrary.SCL_Pure_SetSafeRotatorWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeRotator = SCLibrary.prototype.SCL_Pure_SetSafeRotator; } catch (e) {};
try { SCLibrary.SetSafeRotator = SCLibrary.SCL_Pure_SetSafeRotator; } catch (e) {};
try { SCLibrary.prototype.SetSafeName = SCLibrary.prototype.SCL_Pure_SetSafeNameWithKey; } catch (e) {};
try { SCLibrary.SetSafeName = SCLibrary.SCL_Pure_SetSafeNameWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeName = SCLibrary.prototype.SCL_Pure_SetSafeName; } catch (e) {};
try { SCLibrary.SetSafeName = SCLibrary.SCL_Pure_SetSafeName; } catch (e) {};
try { SCLibrary.prototype.SetSafeInt = SCLibrary.prototype.SCL_Pure_SetSafeIntWithKey; } catch (e) {};
try { SCLibrary.SetSafeInt = SCLibrary.SCL_Pure_SetSafeIntWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeInt = SCLibrary.prototype.SCL_Pure_SetSafeInt; } catch (e) {};
try { SCLibrary.SetSafeInt = SCLibrary.SCL_Pure_SetSafeInt; } catch (e) {};
try { SCLibrary.prototype.SetSafeFloat = SCLibrary.prototype.SCL_Pure_SetSafeFloatWithKey; } catch (e) {};
try { SCLibrary.SetSafeFloat = SCLibrary.SCL_Pure_SetSafeFloatWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeFloat = SCLibrary.prototype.SCL_Pure_SetSafeFloat; } catch (e) {};
try { SCLibrary.SetSafeFloat = SCLibrary.SCL_Pure_SetSafeFloat; } catch (e) {};
try { SCLibrary.prototype.SetSafeColor = SCLibrary.prototype.SCL_Pure_SetSafeColorWithKey; } catch (e) {};
try { SCLibrary.SetSafeColor = SCLibrary.SCL_Pure_SetSafeColorWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeColor = SCLibrary.prototype.SCL_Pure_SetSafeColor; } catch (e) {};
try { SCLibrary.SetSafeColor = SCLibrary.SCL_Pure_SetSafeColor; } catch (e) {};
try { SCLibrary.prototype.SetSafeByte = SCLibrary.prototype.SCL_Pure_SetSafeByteWithKey; } catch (e) {};
try { SCLibrary.SetSafeByte = SCLibrary.SCL_Pure_SetSafeByteWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeByte = SCLibrary.prototype.SCL_Pure_SetSafeByte; } catch (e) {};
try { SCLibrary.SetSafeByte = SCLibrary.SCL_Pure_SetSafeByte; } catch (e) {};
try { SCLibrary.prototype.SetSafeBool = SCLibrary.prototype.SCL_Pure_SetSafeBoolWithKey; } catch (e) {};
try { SCLibrary.SetSafeBool = SCLibrary.SCL_Pure_SetSafeBoolWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeBool = SCLibrary.prototype.SCL_Pure_SetSafeBool; } catch (e) {};
try { SCLibrary.SetSafeBool = SCLibrary.SCL_Pure_SetSafeBool; } catch (e) {};
try { SCLibrary.prototype.GetSafeVector4D = SCLibrary.prototype.SCL_Pure_GetSafeVector4DWithKey; } catch (e) {};
try { SCLibrary.GetSafeVector4D = SCLibrary.SCL_Pure_GetSafeVector4DWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeVector4D = SCLibrary.prototype.SCL_Pure_GetSafeVector4D; } catch (e) {};
try { SCLibrary.GetSafeVector4D = SCLibrary.SCL_Pure_GetSafeVector4D; } catch (e) {};
try { SCLibrary.prototype.GetSafeVector3D = SCLibrary.prototype.SCL_Pure_GetSafeVector3DWithKey; } catch (e) {};
try { SCLibrary.GetSafeVector3D = SCLibrary.SCL_Pure_GetSafeVector3DWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeVector3D = SCLibrary.prototype.SCL_Pure_GetSafeVector3D; } catch (e) {};
try { SCLibrary.GetSafeVector3D = SCLibrary.SCL_Pure_GetSafeVector3D; } catch (e) {};
try { SCLibrary.prototype.GetSafeVector2D = SCLibrary.prototype.SCL_Pure_GetSafeVector2DWithKey; } catch (e) {};
try { SCLibrary.GetSafeVector2D = SCLibrary.SCL_Pure_GetSafeVector2DWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeVector2D = SCLibrary.prototype.SCL_Pure_GetSafeVector2D; } catch (e) {};
try { SCLibrary.GetSafeVector2D = SCLibrary.SCL_Pure_GetSafeVector2D; } catch (e) {};
try { SCLibrary.prototype.GetSafeTransform = SCLibrary.prototype.SCL_Pure_GetSafeTransformWithKey; } catch (e) {};
try { SCLibrary.GetSafeTransform = SCLibrary.SCL_Pure_GetSafeTransformWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeTransform = SCLibrary.prototype.SCL_Pure_GetSafeTransform; } catch (e) {};
try { SCLibrary.GetSafeTransform = SCLibrary.SCL_Pure_GetSafeTransform; } catch (e) {};
try { SCLibrary.prototype.GetSafeText = SCLibrary.prototype.SCL_Pure_GetSafeTextWithKey; } catch (e) {};
try { SCLibrary.GetSafeText = SCLibrary.SCL_Pure_GetSafeTextWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeText = SCLibrary.prototype.SCL_Pure_GetSafeText; } catch (e) {};
try { SCLibrary.GetSafeText = SCLibrary.SCL_Pure_GetSafeText; } catch (e) {};
try { SCLibrary.prototype.GetSafeString = SCLibrary.prototype.SCL_Pure_GetSafeStringWithKey; } catch (e) {};
try { SCLibrary.GetSafeString = SCLibrary.SCL_Pure_GetSafeStringWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeString = SCLibrary.prototype.SCL_Pure_GetSafeString; } catch (e) {};
try { SCLibrary.GetSafeString = SCLibrary.SCL_Pure_GetSafeString; } catch (e) {};
try { SCLibrary.prototype.GetSafeRotator = SCLibrary.prototype.SCL_Pure_GetSafeRotatorWithKey; } catch (e) {};
try { SCLibrary.GetSafeRotator = SCLibrary.SCL_Pure_GetSafeRotatorWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeRotator = SCLibrary.prototype.SCL_Pure_GetSafeRotator; } catch (e) {};
try { SCLibrary.GetSafeRotator = SCLibrary.SCL_Pure_GetSafeRotator; } catch (e) {};
try { SCLibrary.prototype.GetSafeName = SCLibrary.prototype.SCL_Pure_GetSafeNameWithKey; } catch (e) {};
try { SCLibrary.GetSafeName = SCLibrary.SCL_Pure_GetSafeNameWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeName = SCLibrary.prototype.SCL_Pure_GetSafeName; } catch (e) {};
try { SCLibrary.GetSafeName = SCLibrary.SCL_Pure_GetSafeName; } catch (e) {};
try { SCLibrary.prototype.GetSafeInt = SCLibrary.prototype.SCL_Pure_GetSafeIntWithKey; } catch (e) {};
try { SCLibrary.GetSafeInt = SCLibrary.SCL_Pure_GetSafeIntWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeInt = SCLibrary.prototype.SCL_Pure_GetSafeInt; } catch (e) {};
try { SCLibrary.GetSafeInt = SCLibrary.SCL_Pure_GetSafeInt; } catch (e) {};
try { SCLibrary.prototype.GetSafeFloat = SCLibrary.prototype.SCL_Pure_GetSafeFloatWithKey; } catch (e) {};
try { SCLibrary.GetSafeFloat = SCLibrary.SCL_Pure_GetSafeFloatWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeFloat = SCLibrary.prototype.SCL_Pure_GetSafeFloat; } catch (e) {};
try { SCLibrary.GetSafeFloat = SCLibrary.SCL_Pure_GetSafeFloat; } catch (e) {};
try { SCLibrary.prototype.GetSafeColor = SCLibrary.prototype.SCL_Pure_GetSafeColorWithKey; } catch (e) {};
try { SCLibrary.GetSafeColor = SCLibrary.SCL_Pure_GetSafeColorWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeColor = SCLibrary.prototype.SCL_Pure_GetSafeColor; } catch (e) {};
try { SCLibrary.GetSafeColor = SCLibrary.SCL_Pure_GetSafeColor; } catch (e) {};
try { SCLibrary.prototype.GetSafeByte = SCLibrary.prototype.SCL_Pure_GetSafeByteWithKey; } catch (e) {};
try { SCLibrary.GetSafeByte = SCLibrary.SCL_Pure_GetSafeByteWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeByte = SCLibrary.prototype.SCL_Pure_GetSafeByte; } catch (e) {};
try { SCLibrary.GetSafeByte = SCLibrary.SCL_Pure_GetSafeByte; } catch (e) {};
try { SCLibrary.prototype.GetSafeBool = SCLibrary.prototype.SCL_Pure_GetSafeBoolWithKey; } catch (e) {};
try { SCLibrary.GetSafeBool = SCLibrary.SCL_Pure_GetSafeBoolWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeBool = SCLibrary.prototype.SCL_Pure_GetSafeBool; } catch (e) {};
try { SCLibrary.GetSafeBool = SCLibrary.SCL_Pure_GetSafeBool; } catch (e) {};
try { SCLibrary.prototype.SetSafeVector4D = SCLibrary.prototype.SCL_Callable_SetSafeVector4DWithKey; } catch (e) {};
try { SCLibrary.SetSafeVector4D = SCLibrary.SCL_Callable_SetSafeVector4DWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeVector4D = SCLibrary.prototype.SCL_Callable_SetSafeVector4D; } catch (e) {};
try { SCLibrary.SetSafeVector4D = SCLibrary.SCL_Callable_SetSafeVector4D; } catch (e) {};
try { SCLibrary.prototype.SetSafeVector3D = SCLibrary.prototype.SCL_Callable_SetSafeVector3DWithKey; } catch (e) {};
try { SCLibrary.SetSafeVector3D = SCLibrary.SCL_Callable_SetSafeVector3DWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeVector3D = SCLibrary.prototype.SCL_Callable_SetSafeVector3D; } catch (e) {};
try { SCLibrary.SetSafeVector3D = SCLibrary.SCL_Callable_SetSafeVector3D; } catch (e) {};
try { SCLibrary.prototype.SetSafeVector2D = SCLibrary.prototype.SCL_Callable_SetSafeVector2DWithKey; } catch (e) {};
try { SCLibrary.SetSafeVector2D = SCLibrary.SCL_Callable_SetSafeVector2DWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeVector2D = SCLibrary.prototype.SCL_Callable_SetSafeVector2D; } catch (e) {};
try { SCLibrary.SetSafeVector2D = SCLibrary.SCL_Callable_SetSafeVector2D; } catch (e) {};
try { SCLibrary.prototype.SetSafeTransform = SCLibrary.prototype.SCL_Callable_SetSafeTransformWithKey; } catch (e) {};
try { SCLibrary.SetSafeTransform = SCLibrary.SCL_Callable_SetSafeTransformWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeTransform = SCLibrary.prototype.SCL_Callable_SetSafeTransform; } catch (e) {};
try { SCLibrary.SetSafeTransform = SCLibrary.SCL_Callable_SetSafeTransform; } catch (e) {};
try { SCLibrary.prototype.SetSafeText = SCLibrary.prototype.SCL_Callable_SetSafeTextWithKey; } catch (e) {};
try { SCLibrary.SetSafeText = SCLibrary.SCL_Callable_SetSafeTextWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeText = SCLibrary.prototype.SCL_Callable_SetSafeText; } catch (e) {};
try { SCLibrary.SetSafeText = SCLibrary.SCL_Callable_SetSafeText; } catch (e) {};
try { SCLibrary.prototype.SetSafeString = SCLibrary.prototype.SCL_Callable_SetSafeStringWithKey; } catch (e) {};
try { SCLibrary.SetSafeString = SCLibrary.SCL_Callable_SetSafeStringWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeString = SCLibrary.prototype.SCL_Callable_SetSafeString; } catch (e) {};
try { SCLibrary.SetSafeString = SCLibrary.SCL_Callable_SetSafeString; } catch (e) {};
try { SCLibrary.prototype.SetSafeRotator = SCLibrary.prototype.SCL_Callable_SetSafeRotatorWithKey; } catch (e) {};
try { SCLibrary.SetSafeRotator = SCLibrary.SCL_Callable_SetSafeRotatorWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeRotator = SCLibrary.prototype.SCL_Callable_SetSafeRotator; } catch (e) {};
try { SCLibrary.SetSafeRotator = SCLibrary.SCL_Callable_SetSafeRotator; } catch (e) {};
try { SCLibrary.prototype.SetSafeName = SCLibrary.prototype.SCL_Callable_SetSafeNameWithKey; } catch (e) {};
try { SCLibrary.SetSafeName = SCLibrary.SCL_Callable_SetSafeNameWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeName = SCLibrary.prototype.SCL_Callable_SetSafeName; } catch (e) {};
try { SCLibrary.SetSafeName = SCLibrary.SCL_Callable_SetSafeName; } catch (e) {};
try { SCLibrary.prototype.SetSafeInt = SCLibrary.prototype.SCL_Callable_SetSafeIntWithKey; } catch (e) {};
try { SCLibrary.SetSafeInt = SCLibrary.SCL_Callable_SetSafeIntWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeInt = SCLibrary.prototype.SCL_Callable_SetSafeInt; } catch (e) {};
try { SCLibrary.SetSafeInt = SCLibrary.SCL_Callable_SetSafeInt; } catch (e) {};
try { SCLibrary.prototype.SetSafeFloat = SCLibrary.prototype.SCL_Callable_SetSafeFloatWithKey; } catch (e) {};
try { SCLibrary.SetSafeFloat = SCLibrary.SCL_Callable_SetSafeFloatWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeFloat = SCLibrary.prototype.SCL_Callable_SetSafeFloat; } catch (e) {};
try { SCLibrary.SetSafeFloat = SCLibrary.SCL_Callable_SetSafeFloat; } catch (e) {};
try { SCLibrary.prototype.SetSafeColor = SCLibrary.prototype.SCL_Callable_SetSafeColorWithKey; } catch (e) {};
try { SCLibrary.SetSafeColor = SCLibrary.SCL_Callable_SetSafeColorWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeColor = SCLibrary.prototype.SCL_Callable_SetSafeColor; } catch (e) {};
try { SCLibrary.SetSafeColor = SCLibrary.SCL_Callable_SetSafeColor; } catch (e) {};
try { SCLibrary.prototype.SetSafeByte = SCLibrary.prototype.SCL_Callable_SetSafeByteWithKey; } catch (e) {};
try { SCLibrary.SetSafeByte = SCLibrary.SCL_Callable_SetSafeByteWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeByte = SCLibrary.prototype.SCL_Callable_SetSafeByte; } catch (e) {};
try { SCLibrary.SetSafeByte = SCLibrary.SCL_Callable_SetSafeByte; } catch (e) {};
try { SCLibrary.prototype.SetSafeBool = SCLibrary.prototype.SCL_Callable_SetSafeBoolWithKey; } catch (e) {};
try { SCLibrary.SetSafeBool = SCLibrary.SCL_Callable_SetSafeBoolWithKey; } catch (e) {};
try { SCLibrary.prototype.SetSafeBool = SCLibrary.prototype.SCL_Callable_SetSafeBool; } catch (e) {};
try { SCLibrary.SetSafeBool = SCLibrary.SCL_Callable_SetSafeBool; } catch (e) {};
try { SCLibrary.prototype.SetSafeText = SCLibrary.prototype.SCL_Callable_SetRawSafeText; } catch (e) {};
try { SCLibrary.SetSafeText = SCLibrary.SCL_Callable_SetRawSafeText; } catch (e) {};
try { SCLibrary.prototype.SetSafeString = SCLibrary.prototype.SCL_Callable_SetRawSafeString; } catch (e) {};
try { SCLibrary.SetSafeString = SCLibrary.SCL_Callable_SetRawSafeString; } catch (e) {};
try { SCLibrary.prototype.SetSafeName = SCLibrary.prototype.SCL_Callable_SetRawSafeName; } catch (e) {};
try { SCLibrary.SetSafeName = SCLibrary.SCL_Callable_SetRawSafeName; } catch (e) {};
try { SCLibrary.prototype.SetSafeInt = SCLibrary.prototype.SCL_Callable_SetRawSafeInt; } catch (e) {};
try { SCLibrary.SetSafeInt = SCLibrary.SCL_Callable_SetRawSafeInt; } catch (e) {};
try { SCLibrary.prototype.SetSafeFloat = SCLibrary.prototype.SCL_Callable_SetRawSafeFloat; } catch (e) {};
try { SCLibrary.SetSafeFloat = SCLibrary.SCL_Callable_SetRawSafeFloat; } catch (e) {};
try { SCLibrary.prototype.SetSafeByte = SCLibrary.prototype.SCL_Callable_SetRawSafeByte; } catch (e) {};
try { SCLibrary.SetSafeByte = SCLibrary.SCL_Callable_SetRawSafeByte; } catch (e) {};
try { SCLibrary.prototype.SetSafeBool = SCLibrary.prototype.SCL_Callable_SetRawSafeBool; } catch (e) {};
try { SCLibrary.SetSafeBool = SCLibrary.SCL_Callable_SetRawSafeBool; } catch (e) {};
try { SCLibrary.prototype.GetSafeVector4D = SCLibrary.prototype.SCL_Callable_GetSafeVector4DWithKey; } catch (e) {};
try { SCLibrary.GetSafeVector4D = SCLibrary.SCL_Callable_GetSafeVector4DWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeVector4D = SCLibrary.prototype.SCL_Callable_GetSafeVector4D; } catch (e) {};
try { SCLibrary.GetSafeVector4D = SCLibrary.SCL_Callable_GetSafeVector4D; } catch (e) {};
try { SCLibrary.prototype.GetSafeVector3D = SCLibrary.prototype.SCL_Callable_GetSafeVector3DWithKey; } catch (e) {};
try { SCLibrary.GetSafeVector3D = SCLibrary.SCL_Callable_GetSafeVector3DWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeVector3D = SCLibrary.prototype.SCL_Callable_GetSafeVector3D; } catch (e) {};
try { SCLibrary.GetSafeVector3D = SCLibrary.SCL_Callable_GetSafeVector3D; } catch (e) {};
try { SCLibrary.prototype.GetSafeVector2D = SCLibrary.prototype.SCL_Callable_GetSafeVector2DWithKey; } catch (e) {};
try { SCLibrary.GetSafeVector2D = SCLibrary.SCL_Callable_GetSafeVector2DWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeVector2D = SCLibrary.prototype.SCL_Callable_GetSafeVector2D; } catch (e) {};
try { SCLibrary.GetSafeVector2D = SCLibrary.SCL_Callable_GetSafeVector2D; } catch (e) {};
try { SCLibrary.prototype.GetSafeTransform = SCLibrary.prototype.SCL_Callable_GetSafeTransformWithKey; } catch (e) {};
try { SCLibrary.GetSafeTransform = SCLibrary.SCL_Callable_GetSafeTransformWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeTransform = SCLibrary.prototype.SCL_Callable_GetSafeTransform; } catch (e) {};
try { SCLibrary.GetSafeTransform = SCLibrary.SCL_Callable_GetSafeTransform; } catch (e) {};
try { SCLibrary.prototype.GetSafeText = SCLibrary.prototype.SCL_Callable_GetSafeTextWithKey; } catch (e) {};
try { SCLibrary.GetSafeText = SCLibrary.SCL_Callable_GetSafeTextWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeText = SCLibrary.prototype.SCL_Callable_GetSafeText; } catch (e) {};
try { SCLibrary.GetSafeText = SCLibrary.SCL_Callable_GetSafeText; } catch (e) {};
try { SCLibrary.prototype.GetSafeString = SCLibrary.prototype.SCL_Callable_GetSafeStringWithKey; } catch (e) {};
try { SCLibrary.GetSafeString = SCLibrary.SCL_Callable_GetSafeStringWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeString = SCLibrary.prototype.SCL_Callable_GetSafeString; } catch (e) {};
try { SCLibrary.GetSafeString = SCLibrary.SCL_Callable_GetSafeString; } catch (e) {};
try { SCLibrary.prototype.GetSafeRotator = SCLibrary.prototype.SCL_Callable_GetSafeRotatorWithKey; } catch (e) {};
try { SCLibrary.GetSafeRotator = SCLibrary.SCL_Callable_GetSafeRotatorWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeRotator = SCLibrary.prototype.SCL_Callable_GetSafeRotator; } catch (e) {};
try { SCLibrary.GetSafeRotator = SCLibrary.SCL_Callable_GetSafeRotator; } catch (e) {};
try { SCLibrary.prototype.GetSafeName = SCLibrary.prototype.SCL_Callable_GetSafeNameWithKey; } catch (e) {};
try { SCLibrary.GetSafeName = SCLibrary.SCL_Callable_GetSafeNameWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeName = SCLibrary.prototype.SCL_Callable_GetSafeName; } catch (e) {};
try { SCLibrary.GetSafeName = SCLibrary.SCL_Callable_GetSafeName; } catch (e) {};
try { SCLibrary.prototype.GetSafeInt = SCLibrary.prototype.SCL_Callable_GetSafeIntWithKey; } catch (e) {};
try { SCLibrary.GetSafeInt = SCLibrary.SCL_Callable_GetSafeIntWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeInt = SCLibrary.prototype.SCL_Callable_GetSafeInt; } catch (e) {};
try { SCLibrary.GetSafeInt = SCLibrary.SCL_Callable_GetSafeInt; } catch (e) {};
try { SCLibrary.prototype.GetSafeFloat = SCLibrary.prototype.SCL_Callable_GetSafeFloatWithKey; } catch (e) {};
try { SCLibrary.GetSafeFloat = SCLibrary.SCL_Callable_GetSafeFloatWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeFloat = SCLibrary.prototype.SCL_Callable_GetSafeFloat; } catch (e) {};
try { SCLibrary.GetSafeFloat = SCLibrary.SCL_Callable_GetSafeFloat; } catch (e) {};
try { SCLibrary.prototype.GetSafeColor = SCLibrary.prototype.SCL_Callable_GetSafeColorWithKey; } catch (e) {};
try { SCLibrary.GetSafeColor = SCLibrary.SCL_Callable_GetSafeColorWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeColor = SCLibrary.prototype.SCL_Callable_GetSafeColor; } catch (e) {};
try { SCLibrary.GetSafeColor = SCLibrary.SCL_Callable_GetSafeColor; } catch (e) {};
try { SCLibrary.prototype.GetSafeByte = SCLibrary.prototype.SCL_Callable_GetSafeByteWithKey; } catch (e) {};
try { SCLibrary.GetSafeByte = SCLibrary.SCL_Callable_GetSafeByteWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeByte = SCLibrary.prototype.SCL_Callable_GetSafeByte; } catch (e) {};
try { SCLibrary.GetSafeByte = SCLibrary.SCL_Callable_GetSafeByte; } catch (e) {};
try { SCLibrary.prototype.GetSafeBool = SCLibrary.prototype.SCL_Callable_GetSafeBoolWithKey; } catch (e) {};
try { SCLibrary.GetSafeBool = SCLibrary.SCL_Callable_GetSafeBoolWithKey; } catch (e) {};
try { SCLibrary.prototype.GetSafeBool = SCLibrary.prototype.SCL_Callable_GetSafeBool; } catch (e) {};
try { SCLibrary.GetSafeBool = SCLibrary.SCL_Callable_GetSafeBool; } catch (e) {};
try { SCLibrary.prototype.GetSafeText = SCLibrary.prototype.SCL_Callable_GetRawSafeText; } catch (e) {};
try { SCLibrary.GetSafeText = SCLibrary.SCL_Callable_GetRawSafeText; } catch (e) {};
try { SCLibrary.prototype.GetSafeString = SCLibrary.prototype.SCL_Callable_GetRawSafeString; } catch (e) {};
try { SCLibrary.GetSafeString = SCLibrary.SCL_Callable_GetRawSafeString; } catch (e) {};
try { SCLibrary.prototype.GetSafeName = SCLibrary.prototype.SCL_Callable_GetRawSafeName; } catch (e) {};
try { SCLibrary.GetSafeName = SCLibrary.SCL_Callable_GetRawSafeName; } catch (e) {};
try { SCLibrary.prototype.GetSafeInt = SCLibrary.prototype.SCL_Callable_GetRawSafeInt; } catch (e) {};
try { SCLibrary.GetSafeInt = SCLibrary.SCL_Callable_GetRawSafeInt; } catch (e) {};
try { SCLibrary.prototype.GetSafeFloat = SCLibrary.prototype.SCL_Callable_GetRawSafeFloat; } catch (e) {};
try { SCLibrary.GetSafeFloat = SCLibrary.SCL_Callable_GetRawSafeFloat; } catch (e) {};
try { SCLibrary.prototype.GetSafeByte = SCLibrary.prototype.SCL_Callable_GetRawSafeByte; } catch (e) {};
try { SCLibrary.GetSafeByte = SCLibrary.SCL_Callable_GetRawSafeByte; } catch (e) {};
try { SCLibrary.prototype.GetSafeBool = SCLibrary.prototype.SCL_Callable_GetRawSafeBool; } catch (e) {};
try { SCLibrary.GetSafeBool = SCLibrary.SCL_Callable_GetRawSafeBool; } catch (e) {};
...
try { let fnprepatch_652 = UINavWidget.prototype.NavigateTo;UINavWidget.prototype.NavigateTo = function (Index, bHoverEvent = false) { return fnprepatch_652.call(this, Index, bHoverEvent) }; } catch (e) {};
try { let fnprepatch_653 = JavascriptComponent.prototype.ResolveAsset;JavascriptComponent.prototype.ResolveAsset = function (Name, bTryLoad = true) { return fnprepatch_653.call(this, Name, bTryLoad) }; } catch (e) {};
try { let fnprepatch_654 = JavascriptContext.prototype.SetAsDebugContext;JavascriptContext.prototype.SetAsDebugContext = function (InPort = 5858) { return fnprepatch_654.call(this, InPort) }; } catch (e) {};
try { let fnprepatch_655 = JavascriptContext.prototype.RunScript;JavascriptContext.prototype.RunScript = function (Script, bOutput = true) { return fnprepatch_655.call(this, Script, bOutput) }; } catch (e) {};
try { let fnprepatch_656 = JavascriptContext.prototype.CreateInspector;JavascriptContext.prototype.CreateInspector = function (Port = 9229) { return fnprepatch_656.call(this, Port) }; } catch (e) {};
try { let fnprepatch_657 = JavascriptLibrary.prototype.DeleteFile;JavascriptLibrary.prototype.DeleteFile = function (Filename, ReadOnly = false) { return fnprepatch_657.call(this, Filename, ReadOnly) }; } catch (e) {};
try { let fnprepatch_658 = JavascriptLibrary.prototype.CreateSocket;JavascriptLibrary.prototype.CreateSocket = function (SocketType, Description, bForceUDP = false) { return fnprepatch_658.call(this, SocketType, Description, bForceUDP) }; } catch (e) {};
try { let fnprepatch_659 = JavascriptProcess.prototype.Terminate;JavascriptProcess.prototype.Terminate = function (KillTree = false) { return fnprepatch_659.call(this, KillTree) }; } catch (e) {};
try { let fnprepatch_660 = JavascriptUMGLibrary.prototype.AddWindow;JavascriptUMGLibrary.prototype.AddWindow = function (NewWindow, bShowImmediately = true) { return fnprepatch_660.call(this, NewWindow, bShowImmediately) }; } catch (e) {};
...
try { let fnprepatch_661 = VaRestRequestJSON.prototype.SetURL;VaRestRequestJSON.prototype.SetURL = function (Url = "http://alyamkin.com") { return fnprepatch_661.call(this, Url) }; } catch (e) {};
try { let fnprepatch_662 = VaRestRequestJSON.prototype.ProcessURL;VaRestRequestJSON.prototype.ProcessURL = function (Url = "http://alyamkin.com") { return fnprepatch_662.call(this, Url) }; } catch (e) {};
try { let fnprepatch_663 = VaRestRequestJSON.prototype.GetResponseContentAsString;VaRestRequestJSON.prototype.GetResponseContentAsString = function (bCacheResponseContent = true) { return fnprepatch_663.call(this, bCacheResponseContent) }; } catch (e) {};
...
try { let fnprepatch_664 = VtaPluginFunctionLibrary.prototype.DrawSlateTexture9Slice;VtaPluginFunctionLibrary.prototype.DrawSlateTexture9Slice = function (Target, Texture, ScreenX = 0, ScreenY = 0, ScreenW = 100, ScreenH = 100, TextureU = 0, TextureV = 0, TextureUWidth = 1, TextureVHeight = 1, MarginLeft = 0, MarginTop = 0, MarginRight = 0, MarginBottom = 0, OriginalWidth = 0, OriginalHeight = 0, Tint = {"R":1,"G":1,"B":1,"A":1}, BlendMode = "BLEND_Translucent") { return fnprepatch_664.call(this, Target, Texture, ScreenX, ScreenY, ScreenW, ScreenH, TextureU, TextureV, TextureUWidth, TextureVHeight, MarginLeft, MarginTop, MarginRight, MarginBottom, OriginalWidth, OriginalHeight, Tint, BlendMode) }; } catch (e) {};
try { let fnprepatch_665 = VtaPluginFunctionLibrary.prototype.DrawSlateTexture;VtaPluginFunctionLibrary.prototype.DrawSlateTexture = function (Target, Texture, ScreenX = 0, ScreenY = 0, ScreenW = 100, ScreenH = 100, TextureU = 0, TextureV = 0, TextureUWidth = 1, TextureVHeight = 1, Tint = {"R":1,"G":1,"B":1,"A":1}, BlendMode = "BLEND_Translucent", Scale = 1, bScalePosition = false, Rotation = 0, RotPivot, bFlipX = false, bFlipY = false) { return fnprepatch_665.call(this, Target, Texture, ScreenX, ScreenY, ScreenW, ScreenH, TextureU, TextureV, TextureUWidth, TextureVHeight, Tint, BlendMode, Scale, bScalePosition, Rotation, RotPivot, bFlipX, bFlipY) }; } catch (e) {};
try { let fnprepatch_666 = EditableMesh.prototype.EndModification;EditableMesh.prototype.EndModification = function (bFromUndo = false) { return fnprepatch_666.call(this, bFromUndo) }; } catch (e) {};
try { let fnprepatch_667 = LevelVariantSetsActor.prototype.GetLevelVariantSets;LevelVariantSetsActor.prototype.GetLevelVariantSets = function (bLoad = false) { return fnprepatch_667.call(this, bLoad) }; } catch (e) {};
try { let fnprepatch_668 = AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToTIFF;AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToTIFF = function (SourceImage, bWantColor = true, bUseGpu = true, Scale = 1, Rotate = "None") { return fnprepatch_668.call(this, SourceImage, bWantColor, bUseGpu, Scale, Rotate) }; } catch (e) {};
try { let fnprepatch_669 = AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToPNG;AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToPNG = function (SourceImage, bWantColor = true, bUseGpu = true, Scale = 1, Rotate = "None") { return fnprepatch_669.call(this, SourceImage, bWantColor, bUseGpu, Scale, Rotate) }; } catch (e) {};
try { let fnprepatch_670 = AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToJPEG;AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToJPEG = function (SourceImage, Quality = 85, bWantColor = true, bUseGpu = true, Scale = 1, Rotate = "None") { return fnprepatch_670.call(this, SourceImage, Quality, bWantColor, bUseGpu, Scale, Rotate) }; } catch (e) {};
try { let fnprepatch_671 = AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToHEIF;AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToHEIF = function (SourceImage, Quality = 85, bWantColor = true, bUseGpu = true, Scale = 1, Rotate = "None") { return fnprepatch_671.call(this, SourceImage, Quality, bWantColor, bUseGpu, Scale, Rotate) }; } catch (e) {};
...
try { let fnprepatch_672 = HapticManagerComponent.prototype.SubmitFeedbackWithTransform;HapticManagerComponent.prototype.SubmitFeedbackWithTransform = function (Feedback, AltKey, Option, UseAltKey = false) { return fnprepatch_672.call(this, Feedback, AltKey, Option, UseAltKey) }; } catch (e) {};
try { let fnprepatch_673 = HapticManagerComponent.prototype.SubmitFeedbackWithIntensityDuration;HapticManagerComponent.prototype.SubmitFeedbackWithIntensityDuration = function (Feedback, AltKey, RotationOption, ScaleOption, UseAltKey = false) { return fnprepatch_673.call(this, Feedback, AltKey, RotationOption, ScaleOption, UseAltKey) }; } catch (e) {};
try { let fnprepatch_674 = HapticManagerComponent.prototype.ProjectToVest;HapticManagerComponent.prototype.ProjectToVest = function (Location, HitComponent, HalfHeight = 50) { return fnprepatch_674.call(this, Location, HitComponent, HalfHeight) }; } catch (e) {};
try { let fnprepatch_675 = HapticManagerComponent.prototype.CustomProjectToVest;HapticManagerComponent.prototype.CustomProjectToVest = function (Location, HitComponent, HalfHeight = 50, UpVector, ForwardVector) { return fnprepatch_675.call(this, Location, HitComponent, HalfHeight, UpVector, ForwardVector) }; } catch (e) {};
try { HapticManagerComponent.prototype.TurnOffFeedbackFile = HapticManagerComponent.prototype.TurnOffRegisteredFeedbackFile; } catch (e) {};
try { HapticManagerComponent.prototype.TurnOffFeedback = HapticManagerComponent.prototype.TurnOffRegisteredFeedback; } catch (e) {};
try { HapticManagerComponent.prototype.ToggleFeedback = HapticManagerComponent.prototype.ToggleHapticFeedback; } catch (e) {};
try { HapticManagerComponent.prototype.SubmitUsingPaths = HapticManagerComponent.prototype.SubmitPath; } catch (e) {};
try { HapticManagerComponent.prototype.SubmitFeedbackwithScaledIntensityandDuration = HapticManagerComponent.prototype.SubmitFeedbackWithIntensityDuration; } catch (e) {};
try { HapticManagerComponent.prototype.SubmitUsingDots = HapticManagerComponent.prototype.SubmitDots; } catch (e) {};
try { HapticManagerComponent.prototype.SubmitUsingBytes = HapticManagerComponent.prototype.SubmitBytes; } catch (e) {};
try { HapticManagerComponent.prototype.RegisterFeedback = HapticManagerComponent.prototype.RegisterFeedbackFile; } catch (e) {};
try { HapticManagerComponent.prototype.IsFeedbackCurrentlyPlaying = HapticManagerComponent.prototype.IsRegisteredPlaying; } catch (e) {};
try { HapticManagerComponent.prototype.IsFeedbackFileCurrentlyPlaying = HapticManagerComponent.prototype.IsRegisteredFilePlaying; } catch (e) {};
try { HapticManagerComponent.prototype.IsAnyFeedbackCurrentlyPlaying = HapticManagerComponent.prototype.IsAnythingPlaying; } catch (e) {};
try { HapticManagerComponent.prototype.EnableFeedback = HapticManagerComponent.prototype.EnableHapticFeedback; } catch (e) {};
try { HapticManagerComponent.prototype.DisableFeedback = HapticManagerComponent.prototype.DisableHapticFeedback; } catch (e) {};
try { HapticsManagerActor.prototype.SetTactSuitVariables = HapticsManagerActor.prototype.SetTactSuit; } catch (e) {};
...
try { let fnprepatch_676 = SimpleCartesianPlot.prototype.BP_AddSeriesWithId;SimpleCartesianPlot.prototype.BP_AddSeriesWithId = function (bSuccess, Id, Name, bEnabled = true, bShowPoints = true, bShowLines = false) { return fnprepatch_676.call(this, bSuccess, Id, Name, bEnabled, bShowPoints, bShowLines) }; } catch (e) {};
try { let fnprepatch_677 = SimpleCartesianPlot.prototype.BP_AddSeries;SimpleCartesianPlot.prototype.BP_AddSeries = function (SeriesId, Name, bEnabled = true, bShowPoints = true, bShowLines = false) { return fnprepatch_677.call(this, SeriesId, Name, bEnabled, bShowPoints, bShowLines) }; } catch (e) {};
...
try { let fnprepatch_678 = SimpleTimeSeriesPlot.prototype.BP_AddSeriesWithId;SimpleTimeSeriesPlot.prototype.BP_AddSeriesWithId = function (bSuccess, Id, Name, bEnabled = true, bShowPoints = true, bShowLines = false) { return fnprepatch_678.call(this, bSuccess, Id, Name, bEnabled, bShowPoints, bShowLines) }; } catch (e) {};
try { let fnprepatch_679 = SimpleTimeSeriesPlot.prototype.BP_AddSeries;SimpleTimeSeriesPlot.prototype.BP_AddSeries = function (SeriesId, Name, bEnabled = true, bShowPoints = true, bShowLines = false) { return fnprepatch_679.call(this, SeriesId, Name, bEnabled, bShowPoints, bShowLines) }; } catch (e) {};
...
try { let fnprepatch_680 = MidiComponent.prototype.start;MidiComponent.prototype.start = function (background = false, UseGameTime = false) { return fnprepatch_680.call(this, background, UseGameTime) }; } catch (e) {};
try { let fnprepatch_681 = MidiInterfaceComponent.prototype.OpenOutput;MidiInterfaceComponent.prototype.OpenOutput = function (port = 0) { return fnprepatch_681.call(this, port) }; } catch (e) {};
try { let fnprepatch_682 = MidiInterfaceComponent.prototype.OpenInput;MidiInterfaceComponent.prototype.OpenInput = function (port = 0) { return fnprepatch_682.call(this, port) }; } catch (e) {};
try { let fnprepatch_683 = MidiInterface.prototype.OpenMidiOutput;MidiInterface.prototype.OpenMidiOutput = function (port = 0) { return fnprepatch_683.call(this, port) }; } catch (e) {};
...
try { let fnprepatch_684 = SoundUtils.prototype.ConstantNote;SoundUtils.prototype.ConstantNote = function (amplitude = 8192, frequency = 440) { return fnprepatch_684.call(this, amplitude, frequency) }; } catch (e) {};
try { let fnprepatch_685 = SoundUtils.prototype.AudioNote;SoundUtils.prototype.AudioNote = function (amplitude = 8192, frequency = 440, seconds = 1) { return fnprepatch_685.call(this, amplitude, frequency, seconds) }; } catch (e) {};
try { let fnprepatch_686 = RunebergVR_Gaze.prototype.StartGaze;RunebergVR_Gaze.prototype.StartGaze = function (Gaze_Range = 300, Gaze_TargetDuration = 3, DrawDebugLine = false) { return fnprepatch_686.call(this, Gaze_Range, Gaze_TargetDuration, DrawDebugLine) }; } catch (e) {};
try { let fnprepatch_687 = RunebergVR_Gestures.prototype.StopRecordingGesture;RunebergVR_Gestures.prototype.StopRecordingGesture = function (SaveToDB = false) { return fnprepatch_687.call(this, SaveToDB) }; } catch (e) {};
try { let fnprepatch_688 = RunebergVR_Gestures.prototype.DrawVRGesture;RunebergVR_Gestures.prototype.DrawVRGesture = function (VR_Gesture, LineMesh, LineMaterial, OriginLocation, OriginRotation, OffsetLocation, OffsetDistance = 100, Lifetime = 3) { return fnprepatch_688.call(this, VR_Gesture, LineMesh, LineMaterial, OriginLocation, OriginRotation, OffsetLocation, OffsetDistance, Lifetime) }; } catch (e) {};
try { let fnprepatch_689 = RunebergVR_Grabber.prototype.PushGrabbedObject;RunebergVR_Grabber.prototype.PushGrabbedObject = function (PushSpeed = 1, MinDistance = 1, MaxDistance = 20) { return fnprepatch_689.call(this, PushSpeed, MinDistance, MaxDistance) }; } catch (e) {};
try { let fnprepatch_690 = RunebergVR_Grabber.prototype.PullGrabbedObject;RunebergVR_Grabber.prototype.PullGrabbedObject = function (PullSpeed = 1, MinDistance = 1, MaxDistance = 20) { return fnprepatch_690.call(this, PullSpeed, MinDistance, MaxDistance) }; } catch (e) {};
try { let fnprepatch_691 = RunebergVR_Grabber.prototype.GrabSun;RunebergVR_Grabber.prototype.GrabSun = function (Sky_Sphere, SunCycleRate = 2) { return fnprepatch_691.call(this, Sky_Sphere, SunCycleRate) }; } catch (e) {};
try { let fnprepatch_692 = RunebergVR_Grabber.prototype.Grab;RunebergVR_Grabber.prototype.Grab = function (Reach = 5, DoRadialTrace = false, ScanOnlyWillManuallyAttach = false, GrabMode = "PRECISION_GRAB", TagName, Rotation_Offset, RetainObjectRotation = true, RetainDistance = false, ShowDebug = false) { return fnprepatch_692.call(this, Reach, DoRadialTrace, ScanOnlyWillManuallyAttach, GrabMode, TagName, Rotation_Offset, RetainObjectRotation, RetainDistance, ShowDebug) }; } catch (e) {};
try { let fnprepatch_693 = RunebergVR_Movement.prototype.TimedMovement;RunebergVR_Movement.prototype.TimedMovement = function (MovementDuration = 5, MovementSpeed = 3, MovementDirectionReference = undefined, LockPitchY = false, LockYawZ = false, LockRollX = false, CustomDirection, ObeyNavMesh = false) { return fnprepatch_693.call(this, MovementDuration, MovementSpeed, MovementDirectionReference, LockPitchY, LockYawZ, LockRollX, CustomDirection, ObeyNavMesh) }; } catch (e) {};
try { let fnprepatch_694 = RunebergVR_Movement.prototype.TimedDashMove;RunebergVR_Movement.prototype.TimedDashMove = function (MovementDuration = 5, MovementSpeed = 3, MovementDirection, ObeyNavMesh = false) { return fnprepatch_694.call(this, MovementDuration, MovementSpeed, MovementDirection, ObeyNavMesh) }; } catch (e) {};
try { let fnprepatch_695 = RunebergVR_Movement.prototype.EnableVRMovement;RunebergVR_Movement.prototype.EnableVRMovement = function (MovementSpeed = 3, MovementDirectionReference = undefined, ObeyNavMesh = false, LockPitch = false, LockYaw = false, LockRoll = false, CustomDirection) { return fnprepatch_695.call(this, MovementSpeed, MovementDirectionReference, ObeyNavMesh, LockPitch, LockYaw, LockRoll, CustomDirection) }; } catch (e) {};
try { let fnprepatch_696 = RunebergVR_Movement.prototype.Enable360Movement;RunebergVR_Movement.prototype.Enable360Movement = function (MovementDirectionReference = undefined, ObeyNavMesh = false, LockPitch = false, LockYaw = false, LockRoll = false, MovementSpeed = 3, XAxisInput = 0, YAxisInput = 0) { return fnprepatch_696.call(this, MovementDirectionReference, ObeyNavMesh, LockPitch, LockYaw, LockRoll, MovementSpeed, XAxisInput, YAxisInput) }; } catch (e) {};
try { let fnprepatch_697 = RunebergVR_Movement.prototype.BounceBackFromVRBounds;RunebergVR_Movement.prototype.BounceBackFromVRBounds = function (MovementSpeed = 3, MovementDuration = 0.5, ResetMovementStateAfterBounce = false) { return fnprepatch_697.call(this, MovementSpeed, MovementDuration, ResetMovementStateAfterBounce) }; } catch (e) {};
try { let fnprepatch_698 = RunebergVR_Movement.prototype.ApplySpeedMultiplier;RunebergVR_Movement.prototype.ApplySpeedMultiplier = function (SpeedMultiplier = 2, BaseSpeed = 3, UseCurrentSpeedAsBase = false) { return fnprepatch_698.call(this, SpeedMultiplier, BaseSpeed, UseCurrentSpeedAsBase) }; } catch (e) {};
try { let fnprepatch_699 = RunebergVR_Pawn.prototype.RotatePawn;RunebergVR_Pawn.prototype.RotatePawn = function (RotationRate = 1, XAxisInput = 0, YAxisInput = 0) { return fnprepatch_699.call(this, RotationRate, XAxisInput, YAxisInput) }; } catch (e) {};
try { let fnprepatch_700 = RunebergVR_Pawn.prototype.PrintDebugMessage;RunebergVR_Pawn.prototype.PrintDebugMessage = function (Message, OverwriteExisting = false, Duration = 5, Color = {"B":0,"G":0,"R":255,"A":255}) { return fnprepatch_700.call(this, Message, OverwriteExisting, Duration, Color) }; } catch (e) {};
try { let fnprepatch_701 = RunebergVR_Pawn.prototype.OverridePawnValues;RunebergVR_Pawn.prototype.OverridePawnValues = function (PawnBaseEyeHeight = 0, FOV = 110, CapsuleHalfHeight = 96, CapsuleRadius = 22, CapsuleRelativeLocation, SceneLocation, LeftControllerLocation, RightControllerLocation) { return fnprepatch_701.call(this, PawnBaseEyeHeight, FOV, CapsuleHalfHeight, CapsuleRadius, CapsuleRelativeLocation, SceneLocation, LeftControllerLocation, RightControllerLocation) }; } catch (e) {};
try { let fnprepatch_702 = RunebergVR_ScalableMesh.prototype.ScaleMeshUp;RunebergVR_ScalableMesh.prototype.ScaleMeshUp = function (DistanceToScaleUpXYZ, RateXYZ, NewVisibility = true) { return fnprepatch_702.call(this, DistanceToScaleUpXYZ, RateXYZ, NewVisibility) }; } catch (e) {};
try { let fnprepatch_703 = RunebergVR_ScalableMesh.prototype.ScaleMeshToLocation;RunebergVR_ScalableMesh.prototype.ScaleMeshToLocation = function (Target_Location, Scale_Direction = "SCALE_X", Rate = 1, NewVisibility = true) { return fnprepatch_703.call(this, Target_Location, Scale_Direction, Rate, NewVisibility) }; } catch (e) {};
try { let fnprepatch_704 = RunebergVR_ScalableMesh.prototype.ScaleMeshDown;RunebergVR_ScalableMesh.prototype.ScaleMeshDown = function (DistanceToScaleDownXYZ, RateXYZ, VisibilityAfterScale = false) { return fnprepatch_704.call(this, DistanceToScaleDownXYZ, RateXYZ, VisibilityAfterScale) }; } catch (e) {};
try { let fnprepatch_705 = RunebergVR_ScalableMesh.prototype.ScaleDownAndMove;RunebergVR_ScalableMesh.prototype.ScaleDownAndMove = function (Scale_Direction = "SCALE_X", Rate = 1, DistanceCorrection = 100, VisibilityAfterScale = false) { return fnprepatch_705.call(this, Scale_Direction, Rate, DistanceCorrection, VisibilityAfterScale) }; } catch (e) {};
try { let fnprepatch_706 = RunebergVR_SimpleGrabber.prototype.Release;RunebergVR_SimpleGrabber.prototype.Release = function (EnablePhysics = true) { return fnprepatch_706.call(this, EnablePhysics) }; } catch (e) {};
try { let fnprepatch_707 = RunebergVR_SimpleGrabber.prototype.Grab;RunebergVR_SimpleGrabber.prototype.Grab = function (_ObjectTypeID = 5) { return fnprepatch_707.call(this, _ObjectTypeID) }; } catch (e) {};
try { let fnprepatch_708 = RunebergVR_Teleporter.prototype.TeleportNow;RunebergVR_Teleporter.prototype.TeleportNow = function (FadeOutOptions, FadeInOptions, ForceTeleport = false, TeleportPhysics = false) { return fnprepatch_708.call(this, FadeOutOptions, FadeInOptions, ForceTeleport, TeleportPhysics) }; } catch (e) {};
try { let fnprepatch_709 = RunebergVR_Teleporter.prototype.MoveMarker;RunebergVR_Teleporter.prototype.MoveMarker = function (MarkerDirection = "MOVE_FORWARD", Rate = 25, CustomDirection) { return fnprepatch_709.call(this, MarkerDirection, Rate, CustomDirection) }; } catch (e) {};
try { StomtJsonValue.prototype.ConstructJsonStringValue = StomtJsonValue.prototype.ConstructJsonValueString; } catch (e) {};
try { StomtJsonValue.ConstructJsonStringValue = StomtJsonValue.ConstructJsonValueString; } catch (e) {};
try { StomtJsonValue.prototype.ConstructJsonNumberValue = StomtJsonValue.prototype.ConstructJsonValueNumber; } catch (e) {};
try { StomtJsonValue.ConstructJsonNumberValue = StomtJsonValue.ConstructJsonValueNumber; } catch (e) {};
try { StomtJsonValue.prototype.ConstructJsonBoolValue = StomtJsonValue.prototype.ConstructJsonValueBool; } catch (e) {};
try { StomtJsonValue.ConstructJsonBoolValue = StomtJsonValue.ConstructJsonValueBool; } catch (e) {};
try { StomtJsonValue.prototype.ConstructJsonArrayValue = StomtJsonValue.prototype.ConstructJsonValueArray; } catch (e) {};
try { StomtJsonValue.ConstructJsonArrayValue = StomtJsonValue.ConstructJsonValueArray; } catch (e) {};
try { let fnprepatch_710 = TwitchIRCComponent.prototype.SendIRCMessage;TwitchIRCComponent.prototype.SendIRCMessage = function (_message, _b_send_to = true, _channel) { return fnprepatch_710.call(this, _message, _b_send_to, _channel) }; } catch (e) {};
...
try { let fnprepatch_711 = NUTActor.prototype.UnitTravel;NUTActor.prototype.UnitTravel = function (Dest = " ") { return fnprepatch_711.call(this, Dest) }; } catch (e) {};
try { let fnprepatch_712 = NUTActor.prototype.UnitSeamlessTravel;NUTActor.prototype.UnitSeamlessTravel = function (Dest = " ") { return fnprepatch_712.call(this, Dest) }; } catch (e) {};
...
try { let fnprepatch_713 = CableComponent.prototype.SetAttachEndTo;CableComponent.prototype.SetAttachEndTo = function (Actor, ComponentProperty, SocketName = "None") { return fnprepatch_713.call(this, Actor, ComponentProperty, SocketName) }; } catch (e) {};
try { let fnprepatch_714 = SteamVRControllerLibrary.prototype.SetTouchDPadMapping;SteamVRControllerLibrary.prototype.SetTouchDPadMapping = function (NewMapping = "FaceButtons") { return fnprepatch_714.call(this, NewMapping) }; } catch (e) {};
try { let fnprepatch_715 = JavascriptGraphEditorLibrary.prototype.NodeCreator;JavascriptGraphEditorLibrary.prototype.NodeCreator = function (Graph, bSelectNewNode = true) { return fnprepatch_715.call(this, Graph, bSelectNewNode) }; } catch (e) {};
try { let fnprepatch_716 = JavascriptGraphEditorWidget.prototype.JumpToNode;JavascriptGraphEditorWidget.prototype.JumpToNode = function (JumpToMe, bRequestRename = false, bSelectNode = true) { return fnprepatch_716.call(this, JumpToMe, bRequestRename, bSelectNode) }; } catch (e) {};
try { let fnprepatch_717 = JavascriptGraphEdNode.prototype.GetNumOfPins;JavascriptGraphEdNode.prototype.GetNumOfPins = function (Direction = "EGPD_MAX") { return fnprepatch_717.call(this, Direction) }; } catch (e) {};
try { let fnprepatch_718 = JavascriptEditorEngineLibrary.prototype.SelectNone;JavascriptEditorEngineLibrary.prototype.SelectNone = function (Engine, bNoteSelectionChange, bDeselectBSPSurfs, WarnAboutManyActors = true) { return fnprepatch_718.call(this, Engine, bNoteSelectionChange, bDeselectBSPSurfs, WarnAboutManyActors) }; } catch (e) {};
try { let fnprepatch_719 = JavascriptEditorEngineLibrary.prototype.SelectGroup;JavascriptEditorEngineLibrary.prototype.SelectGroup = function (Engine, InGroupActor, bForceSelection = false, bInSelected = true, bNotify = true) { return fnprepatch_719.call(this, Engine, InGroupActor, bForceSelection, bInSelected, bNotify) }; } catch (e) {};
try { let fnprepatch_720 = JavascriptEditorEngineLibrary.prototype.SelectComponent;JavascriptEditorEngineLibrary.prototype.SelectComponent = function (Engine, Component, bInSelected, bNotify, bSelectEvenIfHidden = false) { return fnprepatch_720.call(this, Engine, Component, bInSelected, bNotify, bSelectEvenIfHidden) }; } catch (e) {};
try { let fnprepatch_721 = JavascriptEditorEngineLibrary.prototype.SelectActor;JavascriptEditorEngineLibrary.prototype.SelectActor = function (Engine, Actor, bInSelected, bNotify, bSelectEvenIfHidden = false, bForceRefresh = false) { return fnprepatch_721.call(this, Engine, Actor, bInSelected, bNotify, bSelectEvenIfHidden, bForceRefresh) }; } catch (e) {};
try { let fnprepatch_722 = JavascriptEditorEngineLibrary.prototype.CanSelectActor;JavascriptEditorEngineLibrary.prototype.CanSelectActor = function (Engine, Actor, bInSelected, bSelectEvenIfHidden = false, bWarnIfLevelLocked = false) { return fnprepatch_722.call(this, Engine, Actor, bInSelected, bSelectEvenIfHidden, bWarnIfLevelLocked) }; } catch (e) {};
try { let fnprepatch_723 = JavascriptEditorEngineLibrary.prototype.bspBrushCSG;JavascriptEditorEngineLibrary.prototype.bspBrushCSG = function (Engine, Actor, Model, PolyFlags, BrushType, CSGOper, bBuildBounds, bMergePolys, bReplaceNULLMaterialRefs, bShowProgressBar = true) { return fnprepatch_723.call(this, Engine, Actor, Model, PolyFlags, BrushType, CSGOper, bBuildBounds, bMergePolys, bReplaceNULLMaterialRefs, bShowProgressBar) }; } catch (e) {};
try { let fnprepatch_724 = JavascriptEditorLibrary.prototype.SetAlphamapDataFromMemory;JavascriptEditorLibrary.prototype.SetAlphamapDataFromMemory = function (LandscapeInfo, LayerInfo, MinX, MinY, MaxX, MaxY, PaintingRestriction = "None") { return fnprepatch_724.call(this, LandscapeInfo, LayerInfo, MinX, MinY, MaxX, MaxY, PaintingRestriction) }; } catch (e) {};
try { let fnprepatch_725 = JavascriptEditorLibrary.prototype.RemoveComponentFromBlueprint;JavascriptEditorLibrary.prototype.RemoveComponentFromBlueprint = function (Blueprint, RemoveComponent, bPromoteChildren = false) { return fnprepatch_725.call(this, Blueprint, RemoveComponent, bPromoteChildren) }; } catch (e) {};
try { let fnprepatch_726 = JavascriptEditorLibrary.prototype.ModifyObject;JavascriptEditorLibrary.prototype.ModifyObject = function (Object, bAlwaysMarkDirty = false) { return fnprepatch_726.call(this, Object, bAlwaysMarkDirty) }; } catch (e) {};
try { let fnprepatch_727 = JavascriptEditorLibrary.prototype.GetLayerInfoByName;JavascriptEditorLibrary.prototype.GetLayerInfoByName = function (LandscapeInfo, LayerName, Owner = undefined) { return fnprepatch_727.call(this, LandscapeInfo, LayerName, Owner) }; } catch (e) {};
try { let fnprepatch_728 = JavascriptEditorLibrary.prototype.GetAssetsByType;JavascriptEditorLibrary.prototype.GetAssetsByType = function (Types, bRecursiveClasses = true) { return fnprepatch_728.call(this, Types, bRecursiveClasses) }; } catch (e) {};
try { let fnprepatch_729 = JavascriptEditorLibrary.prototype.DeselectAll;JavascriptEditorLibrary.prototype.DeselectAll = function (Selection, InClass = null) { return fnprepatch_729.call(this, Selection, InClass) }; } catch (e) {};
try { let fnprepatch_730 = JavascriptEditorLibrary.prototype.Build;JavascriptEditorLibrary.prototype.Build = function (Builder, InWorld, InBrush = undefined) { return fnprepatch_730.call(this, Builder, InWorld, InBrush) }; } catch (e) {};
try { let fnprepatch_731 = JavascriptEditorLibrary.prototype.AddComponentsToBlueprint;JavascriptEditorLibrary.prototype.AddComponentsToBlueprint = function (Blueprint, Components, bHarvesting = false, OptionalNewRootComponent = undefined, bKeepMobility = false) { return fnprepatch_731.call(this, Blueprint, Components, bHarvesting, OptionalNewRootComponent, bKeepMobility) }; } catch (e) {};
...
try { Faction.prototype.IsNone = Faction.prototype.FactionIsNone; } catch (e) {};
try { SafeTransform.prototype.GetSafeTransform = SafeTransform.prototype.SCL_Callable_GetSafeTransform; } catch (e) {};
try { SafeTransform.prototype.GetSafeTransform = SafeTransform.prototype.SCL_Callable_GetSafeTransformWithKey; } catch (e) {};
try { SafeTransform.prototype.SetSafeTransform = SafeTransform.prototype.SCL_Callable_SetSafeTransform; } catch (e) {};
try { SafeTransform.prototype.SetSafeTransform = SafeTransform.prototype.SCL_Callable_SetSafeTransformWithKey; } catch (e) {};
try { SafeTransform.prototype.GetSafeTransform = SafeTransform.prototype.SCL_Pure_GetSafeTransform; } catch (e) {};
try { SafeTransform.prototype.GetSafeTransform = SafeTransform.prototype.SCL_Pure_GetSafeTransformWithKey; } catch (e) {};
try { SafeTransform.prototype.SetSafeTransform = SafeTransform.prototype.SCL_Pure_SetSafeTransform; } catch (e) {};
try { SafeTransform.prototype.SetSafeTransform = SafeTransform.prototype.SCL_Pure_SetSafeTransformWithKey; } catch (e) {};
try { SafeRotator.prototype.GetSafeRotator = SafeRotator.prototype.SCL_Callable_GetSafeRotator; } catch (e) {};
try { SafeRotator.prototype.GetSafeRotator = SafeRotator.prototype.SCL_Callable_GetSafeRotatorWithKey; } catch (e) {};
try { SafeRotator.prototype.SetSafeRotator = SafeRotator.prototype.SCL_Callable_SetSafeRotator; } catch (e) {};
try { SafeRotator.prototype.SetSafeRotator = SafeRotator.prototype.SCL_Callable_SetSafeRotatorWithKey; } catch (e) {};
try { SafeRotator.prototype.GetSafeRotator = SafeRotator.prototype.SCL_Pure_GetSafeRotator; } catch (e) {};
try { SafeRotator.prototype.GetSafeRotator = SafeRotator.prototype.SCL_Pure_GetSafeRotatorWithKey; } catch (e) {};
try { SafeRotator.prototype.SetSafeRotator = SafeRotator.prototype.SCL_Pure_SetSafeRotator; } catch (e) {};
try { SafeRotator.prototype.SetSafeRotator = SafeRotator.prototype.SCL_Pure_SetSafeRotatorWithKey; } catch (e) {};
try { SafeVector3D.prototype.GetSafeVector3D = SafeVector3D.prototype.SCL_Callable_GetSafeVector3D; } catch (e) {};
try { SafeVector3D.prototype.GetSafeVector3D = SafeVector3D.prototype.SCL_Callable_GetSafeVector3DWithKey; } catch (e) {};
try { SafeVector3D.prototype.SetSafeVector3D = SafeVector3D.prototype.SCL_Callable_SetSafeVector3D; } catch (e) {};
try { SafeVector3D.prototype.SetSafeVector3D = SafeVector3D.prototype.SCL_Callable_SetSafeVector3DWithKey; } catch (e) {};
try { SafeVector3D.prototype.GetSafeVector3D = SafeVector3D.prototype.SCL_Pure_GetSafeVector3D; } catch (e) {};
try { SafeVector3D.prototype.GetSafeVector3D = SafeVector3D.prototype.SCL_Pure_GetSafeVector3DWithKey; } catch (e) {};
try { SafeVector3D.prototype.SetSafeVector3D = SafeVector3D.prototype.SCL_Pure_SetSafeVector3D; } catch (e) {};
try { SafeVector3D.prototype.SetSafeVector3D = SafeVector3D.prototype.SCL_Pure_SetSafeVector3DWithKey; } catch (e) {};
try { SafeColor.prototype.GetSafeColor = SafeColor.prototype.SCL_Callable_GetSafeColor; } catch (e) {};
try { SafeColor.prototype.GetSafeColor = SafeColor.prototype.SCL_Callable_GetSafeColorWithKey; } catch (e) {};
try { SafeColor.prototype.SetSafeColor = SafeColor.prototype.SCL_Callable_SetSafeColor; } catch (e) {};
try { SafeColor.prototype.SetSafeColor = SafeColor.prototype.SCL_Callable_SetSafeColorWithKey; } catch (e) {};
try { SafeColor.prototype.GetSafeColor = SafeColor.prototype.SCL_Pure_GetSafeColor; } catch (e) {};
try { SafeColor.prototype.GetSafeColor = SafeColor.prototype.SCL_Pure_GetSafeColorWithKey; } catch (e) {};
try { SafeColor.prototype.SetSafeColor = SafeColor.prototype.SCL_Pure_SetSafeColor; } catch (e) {};
try { SafeColor.prototype.SetSafeColor = SafeColor.prototype.SCL_Pure_SetSafeColorWithKey; } catch (e) {};
try { SafeVector4D.prototype.GetSafeVector4D = SafeVector4D.prototype.SCL_Callable_GetSafeVector4D; } catch (e) {};
try { SafeVector4D.prototype.GetSafeVector4D = SafeVector4D.prototype.SCL_Callable_GetSafeVector4DWithKey; } catch (e) {};
try { SafeVector4D.prototype.SetSafeVector4D = SafeVector4D.prototype.SCL_Callable_SetSafeVector4D; } catch (e) {};
try { SafeVector4D.prototype.SetSafeVector4D = SafeVector4D.prototype.SCL_Callable_SetSafeVector4DWithKey; } catch (e) {};
try { SafeVector4D.prototype.GetSafeVector4D = SafeVector4D.prototype.SCL_Pure_GetSafeVector4D; } catch (e) {};
try { SafeVector4D.prototype.GetSafeVector4D = SafeVector4D.prototype.SCL_Pure_GetSafeVector4DWithKey; } catch (e) {};
try { SafeVector4D.prototype.SetSafeVector4D = SafeVector4D.prototype.SCL_Pure_SetSafeVector4D; } catch (e) {};
try { SafeVector4D.prototype.SetSafeVector4D = SafeVector4D.prototype.SCL_Pure_SetSafeVector4DWithKey; } catch (e) {};
try { SafeVector2D.prototype.GetSafeVector2D = SafeVector2D.prototype.SCL_Callable_GetSafeVector2D; } catch (e) {};
try { SafeVector2D.prototype.GetSafeVector2D = SafeVector2D.prototype.SCL_Callable_GetSafeVector2DWithKey; } catch (e) {};
try { SafeVector2D.prototype.SetSafeVector2D = SafeVector2D.prototype.SCL_Callable_SetSafeVector2D; } catch (e) {};
try { SafeVector2D.prototype.SetSafeVector2D = SafeVector2D.prototype.SCL_Callable_SetSafeVector2DWithKey; } catch (e) {};
try { SafeVector2D.prototype.GetSafeVector2D = SafeVector2D.prototype.SCL_Pure_GetSafeVector2D; } catch (e) {};
try { SafeVector2D.prototype.GetSafeVector2D = SafeVector2D.prototype.SCL_Pure_GetSafeVector2DWithKey; } catch (e) {};
try { SafeVector2D.prototype.SetSafeVector2D = SafeVector2D.prototype.SCL_Pure_SetSafeVector2D; } catch (e) {};
try { SafeVector2D.prototype.SetSafeVector2D = SafeVector2D.prototype.SCL_Pure_SetSafeVector2DWithKey; } catch (e) {};
try { SafeText.prototype.GetSafeText = SafeText.prototype.SCL_Callable_GetRawSafeText; } catch (e) {};
try { SafeText.prototype.GetSafeText = SafeText.prototype.SCL_Callable_GetSafeText; } catch (e) {};
try { SafeText.prototype.GetSafeText = SafeText.prototype.SCL_Callable_GetSafeTextWithKey; } catch (e) {};
try { SafeText.prototype.SetSafeText = SafeText.prototype.SCL_Callable_SetRawSafeText; } catch (e) {};
try { SafeText.prototype.SetSafeText = SafeText.prototype.SCL_Callable_SetSafeText; } catch (e) {};
try { SafeText.prototype.SetSafeText = SafeText.prototype.SCL_Callable_SetSafeTextWithKey; } catch (e) {};
try { SafeText.prototype.GetSafeText = SafeText.prototype.SCL_Pure_GetSafeText; } catch (e) {};
try { SafeText.prototype.GetSafeText = SafeText.prototype.SCL_Pure_GetSafeTextWithKey; } catch (e) {};
try { SafeText.prototype.SetSafeText = SafeText.prototype.SCL_Pure_SetSafeText; } catch (e) {};
try { SafeText.prototype.SetSafeText = SafeText.prototype.SCL_Pure_SetSafeTextWithKey; } catch (e) {};
try { SafeString.prototype.GetSafeString = SafeString.prototype.SCL_Callable_GetRawSafeString; } catch (e) {};
try { SafeString.prototype.GetSafeString = SafeString.prototype.SCL_Callable_GetSafeString; } catch (e) {};
try { SafeString.prototype.GetSafeString = SafeString.prototype.SCL_Callable_GetSafeStringWithKey; } catch (e) {};
try { SafeString.prototype.SetSafeString = SafeString.prototype.SCL_Callable_SetRawSafeString; } catch (e) {};
try { SafeString.prototype.SetSafeString = SafeString.prototype.SCL_Callable_SetSafeString; } catch (e) {};
try { SafeString.prototype.SetSafeString = SafeString.prototype.SCL_Callable_SetSafeStringWithKey; } catch (e) {};
try { SafeString.prototype.GetSafeString = SafeString.prototype.SCL_Pure_GetSafeString; } catch (e) {};
try { SafeString.prototype.GetSafeString = SafeString.prototype.SCL_Pure_GetSafeStringWithKey; } catch (e) {};
try { SafeString.prototype.SetSafeString = SafeString.prototype.SCL_Pure_SetSafeString; } catch (e) {};
try { SafeString.prototype.SetSafeString = SafeString.prototype.SCL_Pure_SetSafeStringWithKey; } catch (e) {};
try { SafeName.prototype.GetSafeName = SafeName.prototype.SCL_Callable_GetRawSafeName; } catch (e) {};
try { SafeName.prototype.GetSafeName = SafeName.prototype.SCL_Callable_GetSafeName; } catch (e) {};
try { SafeName.prototype.GetSafeName = SafeName.prototype.SCL_Callable_GetSafeNameWithKey; } catch (e) {};
try { SafeName.prototype.SetSafeName = SafeName.prototype.SCL_Callable_SetRawSafeName; } catch (e) {};
try { SafeName.prototype.SetSafeName = SafeName.prototype.SCL_Callable_SetSafeName; } catch (e) {};
try { SafeName.prototype.SetSafeName = SafeName.prototype.SCL_Callable_SetSafeNameWithKey; } catch (e) {};
try { SafeName.prototype.GetSafeName = SafeName.prototype.SCL_Pure_GetSafeName; } catch (e) {};
try { SafeName.prototype.GetSafeName = SafeName.prototype.SCL_Pure_GetSafeNameWithKey; } catch (e) {};
try { SafeName.prototype.SetSafeName = SafeName.prototype.SCL_Pure_SetSafeName; } catch (e) {};
try { SafeName.prototype.SetSafeName = SafeName.prototype.SCL_Pure_SetSafeNameWithKey; } catch (e) {};
try { SafeFloat.prototype.GetSafeFloat = SafeFloat.prototype.SCL_Callable_GetRawSafeFloat; } catch (e) {};
try { SafeFloat.prototype.GetSafeFloat = SafeFloat.prototype.SCL_Callable_GetSafeFloat; } catch (e) {};
try { SafeFloat.prototype.GetSafeFloat = SafeFloat.prototype.SCL_Callable_GetSafeFloatWithKey; } catch (e) {};
try { SafeFloat.prototype.SetSafeFloat = SafeFloat.prototype.SCL_Callable_SetRawSafeFloat; } catch (e) {};
try { SafeFloat.prototype.SetSafeFloat = SafeFloat.prototype.SCL_Callable_SetSafeFloat; } catch (e) {};
try { SafeFloat.prototype.SetSafeFloat = SafeFloat.prototype.SCL_Callable_SetSafeFloatWithKey; } catch (e) {};
try { SafeFloat.prototype.GetSafeFloat = SafeFloat.prototype.SCL_Pure_GetSafeFloat; } catch (e) {};
try { SafeFloat.prototype.GetSafeFloat = SafeFloat.prototype.SCL_Pure_GetSafeFloatWithKey; } catch (e) {};
try { SafeFloat.prototype.SetSafeFloat = SafeFloat.prototype.SCL_Pure_SetSafeFloat; } catch (e) {};
try { SafeFloat.prototype.SetSafeFloat = SafeFloat.prototype.SCL_Pure_SetSafeFloatWithKey; } catch (e) {};
try { SafeInt.prototype.GetSafeInt = SafeInt.prototype.SCL_Callable_GetRawSafeInt; } catch (e) {};
try { SafeInt.prototype.GetSafeInt = SafeInt.prototype.SCL_Callable_GetSafeInt; } catch (e) {};
try { SafeInt.prototype.GetSafeInt = SafeInt.prototype.SCL_Callable_GetSafeIntWithKey; } catch (e) {};
try { SafeInt.prototype.SetSafeInt = SafeInt.prototype.SCL_Callable_SetRawSafeInt; } catch (e) {};
try { SafeInt.prototype.SetSafeInt = SafeInt.prototype.SCL_Callable_SetSafeInt; } catch (e) {};
try { SafeInt.prototype.SetSafeInt = SafeInt.prototype.SCL_Callable_SetSafeIntWithKey; } catch (e) {};
try { SafeInt.prototype.GetSafeInt = SafeInt.prototype.SCL_Pure_GetSafeInt; } catch (e) {};
try { SafeInt.prototype.GetSafeInt = SafeInt.prototype.SCL_Pure_GetSafeIntWithKey; } catch (e) {};
try { SafeInt.prototype.SetSafeInt = SafeInt.prototype.SCL_Pure_SetSafeInt; } catch (e) {};
try { SafeInt.prototype.SetSafeInt = SafeInt.prototype.SCL_Pure_SetSafeIntWithKey; } catch (e) {};
try { SafeByte.prototype.GetSafeByte = SafeByte.prototype.SCL_Callable_GetRawSafeByte; } catch (e) {};
try { SafeByte.prototype.GetSafeByte = SafeByte.prototype.SCL_Callable_GetSafeByte; } catch (e) {};
try { SafeByte.prototype.GetSafeByte = SafeByte.prototype.SCL_Callable_GetSafeByteWithKey; } catch (e) {};
try { SafeByte.prototype.SetSafeByte = SafeByte.prototype.SCL_Callable_SetRawSafeByte; } catch (e) {};
try { SafeByte.prototype.SetSafeByte = SafeByte.prototype.SCL_Callable_SetSafeByte; } catch (e) {};
try { SafeByte.prototype.SetSafeByte = SafeByte.prototype.SCL_Callable_SetSafeByteWithKey; } catch (e) {};
try { SafeByte.prototype.GetSafeByte = SafeByte.prototype.SCL_Pure_GetSafeByte; } catch (e) {};
try { SafeByte.prototype.GetSafeByte = SafeByte.prototype.SCL_Pure_GetSafeByteWithKey; } catch (e) {};
try { SafeByte.prototype.SetSafeByte = SafeByte.prototype.SCL_Pure_SetSafeByte; } catch (e) {};
try { SafeByte.prototype.SetSafeByte = SafeByte.prototype.SCL_Pure_SetSafeByteWithKey; } catch (e) {};
try { SafeBool.prototype.GetSafeBool = SafeBool.prototype.SCL_Callable_GetRawSafeBool; } catch (e) {};
try { SafeBool.prototype.GetSafeBool = SafeBool.prototype.SCL_Callable_GetSafeBool; } catch (e) {};
try { SafeBool.prototype.GetSafeBool = SafeBool.prototype.SCL_Callable_GetSafeBoolWithKey; } catch (e) {};
try { SafeBool.prototype.SetSafeBool = SafeBool.prototype.SCL_Callable_SetRawSafeBool; } catch (e) {};
try { SafeBool.prototype.SetSafeBool = SafeBool.prototype.SCL_Callable_SetSafeBool; } catch (e) {};
try { SafeBool.prototype.SetSafeBool = SafeBool.prototype.SCL_Callable_SetSafeBoolWithKey; } catch (e) {};
try { SafeBool.prototype.GetSafeBool = SafeBool.prototype.SCL_Pure_GetSafeBool; } catch (e) {};
try { SafeBool.prototype.GetSafeBool = SafeBool.prototype.SCL_Pure_GetSafeBoolWithKey; } catch (e) {};
try { SafeBool.prototype.SetSafeBool = SafeBool.prototype.SCL_Pure_SetSafeBool; } catch (e) {};
try { SafeBool.prototype.SetSafeBool = SafeBool.prototype.SCL_Pure_SetSafeBoolWithKey; } catch (e) {};
